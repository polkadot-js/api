[Polkadot JS API](../README.md) › [Globals](../globals.md) › ["packages/types/src/ethereum/LookupSource"](_packages_types_src_ethereum_lookupsource_.md)
...
*Defined in [packages/types/src/ethereum/LookupSource.ts:18](https://github.com/polkadot-js/api/blob/c10e4d3fc1/packages/types/src/ethereum/LookupSource.ts#L18)*
