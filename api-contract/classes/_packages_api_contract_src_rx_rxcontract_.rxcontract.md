...
*Defined in [packages/api-contract/src/rx/RxContract.ts:13](https://github.com/polkadot-js/api/blob/19d6165bd/packages/api-contract/src/rx/RxContract.ts#L13)*
