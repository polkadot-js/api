...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/c10e4d3fc1/packages/api-contract/src/rx/RxContract.ts#L14)*
