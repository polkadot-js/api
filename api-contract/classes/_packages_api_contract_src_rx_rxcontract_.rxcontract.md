...
*Defined in [packages/api-contract/src/rx/RxContract.ts:13](https://github.com/polkadot-js/api/blob/d3703c072/packages/api-contract/src/rx/RxContract.ts#L13)*
