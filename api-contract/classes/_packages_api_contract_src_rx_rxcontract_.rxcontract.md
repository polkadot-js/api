...
> [Globals](../globals.md) / ["packages/api-contract/src/rx/RxContract"](../modules/_packages_api_contract_src_rx_rxcontract_.md) / RxContract
...
*Defined in [packages/api-contract/src/rx/RxContract.ts:13](https://github.com/polkadot-js/api/blob/cc926596e/packages/api-contract/src/rx/RxContract.ts#L13)*
