...
*Defined in [packages/api-contract/src/rx/RxContract.ts:13](https://github.com/polkadot-js/api/blob/ff59962c5/packages/api-contract/src/rx/RxContract.ts#L13)*
