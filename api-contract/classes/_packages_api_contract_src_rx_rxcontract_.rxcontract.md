...
*Defined in [packages/api-contract/src/rx/RxContract.ts:13](https://github.com/polkadot-js/api/blob/e055438c5/packages/api-contract/src/rx/RxContract.ts#L13)*
