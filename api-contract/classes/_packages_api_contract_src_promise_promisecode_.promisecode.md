...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:12](https://github.com/polkadot-js/api/blob/d20228788/packages/api-contract/src/promise/PromiseCode.ts#L12)*
