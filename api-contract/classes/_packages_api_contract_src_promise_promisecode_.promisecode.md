...
> [Globals](../globals.md) / ["packages/api-contract/src/promise/PromiseCode"](../modules/_packages_api_contract_src_promise_promisecode_.md) / PromiseCode
...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:12](https://github.com/polkadot-js/api/blob/f778bf32e/packages/api-contract/src/promise/PromiseCode.ts#L12)*
...
*Defined in [packages/api-contract/src/base/Code.ts:38](https://github.com/polkadot-js/api/blob/f778bf32e/packages/api-contract/src/base/Code.ts#L38)*
...
*Defined in [packages/api-contract/src/base/Code.ts:46](https://github.com/polkadot-js/api/blob/f778bf32e/packages/api-contract/src/base/Code.ts#L46)*
