...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/c10e4d3fc1/packages/api-contract/src/promise/PromiseCode.ts#L13)*
