...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/4596e434d/packages/api-contract/src/promise/PromiseCode.ts#L13)*
