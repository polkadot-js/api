...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:12](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api-contract/src/promise/PromiseCode.ts#L12)*
...
*Defined in [packages/api-contract/src/base/Code.ts:38](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api-contract/src/base/Code.ts#L38)*
...
*Defined in [packages/api-contract/src/base/Code.ts:46](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api-contract/src/base/Code.ts#L46)*
