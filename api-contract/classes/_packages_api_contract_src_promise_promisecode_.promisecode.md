...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:12](https://github.com/polkadot-js/api/blob/8631f68ba/packages/api-contract/src/promise/PromiseCode.ts#L12)*
