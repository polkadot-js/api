...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:12](https://github.com/polkadot-js/api/blob/b4cae1483/packages/api-contract/src/promise/PromiseCode.ts#L12)*
...
*Defined in [packages/api-contract/src/base/Code.ts:38](https://github.com/polkadot-js/api/blob/b4cae1483/packages/api-contract/src/base/Code.ts#L38)*
...
*Defined in [packages/api-contract/src/base/Code.ts:46](https://github.com/polkadot-js/api/blob/b4cae1483/packages/api-contract/src/base/Code.ts#L46)*
