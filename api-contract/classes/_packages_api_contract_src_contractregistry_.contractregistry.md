...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/d3703c072/packages/api-contract/src/MetaRegistry.ts#L106)*
