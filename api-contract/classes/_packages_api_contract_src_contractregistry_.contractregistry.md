...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/014fa123b/packages/api-contract/src/MetaRegistry.ts#L106)*
