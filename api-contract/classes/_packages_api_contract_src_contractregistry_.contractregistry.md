...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/73ffb034d/packages/api-contract/src/MetaRegistry.ts#L106)*
