...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api-contract/src/MetaRegistry.ts#L106)*
