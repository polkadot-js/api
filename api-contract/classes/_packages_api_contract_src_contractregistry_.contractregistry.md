...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/cb93cb34b/packages/api-contract/src/MetaRegistry.ts#L106)*
