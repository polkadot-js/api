...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/8631f68ba/packages/api-contract/src/MetaRegistry.ts#L106)*
