...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/7070f757c/packages/api-contract/src/MetaRegistry.ts#L106)*
