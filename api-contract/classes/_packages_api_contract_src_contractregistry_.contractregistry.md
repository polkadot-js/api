...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api-contract/src/MetaRegistry.ts#L106)*
