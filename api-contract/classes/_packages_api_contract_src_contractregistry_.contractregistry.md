...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/ee6b6da02/packages/api-contract/src/MetaRegistry.ts#L106)*
