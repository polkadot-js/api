...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/ff59962c5/packages/api-contract/src/MetaRegistry.ts#L106)*
