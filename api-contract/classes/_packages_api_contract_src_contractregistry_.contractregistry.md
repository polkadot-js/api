...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/33c161f87/packages/api-contract/src/MetaRegistry.ts#L106)*
