...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api-contract/src/MetaRegistry.ts#L106)*
