...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/0c99064b1/packages/api-contract/src/MetaRegistry.ts#L106)*
