...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/820dd3d0f/packages/api-contract/src/MetaRegistry.ts#L106)*
