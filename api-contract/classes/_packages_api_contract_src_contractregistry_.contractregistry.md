...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/375dadbe3/packages/api-contract/src/MetaRegistry.ts#L106)*
