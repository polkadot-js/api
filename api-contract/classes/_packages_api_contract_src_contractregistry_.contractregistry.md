...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/eda5edbd4/packages/api-contract/src/MetaRegistry.ts#L106)*
