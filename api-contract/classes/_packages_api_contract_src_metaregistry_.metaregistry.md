...
*Defined in [packages/api-contract/src/MetaRegistry.ts:106](https://github.com/polkadot-js/api/blob/f778bf32e/packages/api-contract/src/MetaRegistry.ts#L106)*
