...
> [Globals](../globals.md) / ["packages/api-contract/src/rx/RxCode"](../modules/_packages_api_contract_src_rx_rxcode_.md) / RxCode
...
*Defined in [packages/api-contract/src/rx/RxCode.ts:12](https://github.com/polkadot-js/api/blob/f778bf32e/packages/api-contract/src/rx/RxCode.ts#L12)*
