...
*Defined in [packages/api-contract/src/Abi.ts:16](https://github.com/polkadot-js/api/blob/acb565d46/packages/api-contract/src/Abi.ts#L16)*
...
*Defined in [packages/api-contract/src/Abi.ts:12](https://github.com/polkadot-js/api/blob/acb565d46/packages/api-contract/src/Abi.ts#L12)*
...
*Defined in [packages/api-contract/src/Abi.ts:14](https://github.com/polkadot-js/api/blob/acb565d46/packages/api-contract/src/Abi.ts#L14)*
