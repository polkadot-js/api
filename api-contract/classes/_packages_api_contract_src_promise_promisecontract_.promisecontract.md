...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/acb565d46/packages/api-contract/src/promise/PromiseContract.ts#L13)*
