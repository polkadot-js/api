...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/e055438c5/packages/api-contract/src/promise/PromiseContract.ts#L13)*
