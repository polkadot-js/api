...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/c6bc664f8/packages/api-contract/src/promise/PromiseContract.ts#L13)*
