...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/6faea13a2/packages/api-contract/src/promise/PromiseContract.ts#L13)*
