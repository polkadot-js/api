...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api-contract/src/promise/PromiseContract.ts#L13)*
