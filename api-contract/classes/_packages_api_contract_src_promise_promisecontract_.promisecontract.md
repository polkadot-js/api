...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/7070f757c/packages/api-contract/src/promise/PromiseContract.ts#L13)*
