...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/33c161f87/packages/api-contract/src/promise/PromiseContract.ts#L13)*
