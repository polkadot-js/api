...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/014fa123b/packages/api-contract/src/promise/PromiseContract.ts#L13)*
