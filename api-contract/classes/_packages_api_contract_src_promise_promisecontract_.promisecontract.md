...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/0c99064b1/packages/api-contract/src/promise/PromiseContract.ts#L13)*
