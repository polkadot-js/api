...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/7af915185/packages/api-contract/src/promise/PromiseContract.ts#L13)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:34](https://github.com/polkadot-js/api/blob/7af915185/packages/api-contract/src/base/Contract.ts#L34)*
...
*Defined in [packages/api-contract/src/base/util.ts:69](https://github.com/polkadot-js/api/blob/7af915185/packages/api-contract/src/base/util.ts#L69)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:42](https://github.com/polkadot-js/api/blob/7af915185/packages/api-contract/src/base/Contract.ts#L42)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:43](https://github.com/polkadot-js/api/blob/7af915185/packages/api-contract/src/base/Contract.ts#L43)*
