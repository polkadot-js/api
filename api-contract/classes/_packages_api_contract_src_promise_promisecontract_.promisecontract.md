...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:13](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api-contract/src/promise/PromiseContract.ts#L13)*
