...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/f778bf32e/packages/api-contract/src/base/Contract.ts#L26)*
