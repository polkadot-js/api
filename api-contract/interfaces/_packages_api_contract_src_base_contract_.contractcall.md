...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/73ffb034d/packages/api-contract/src/base/Contract.ts#L26)*
