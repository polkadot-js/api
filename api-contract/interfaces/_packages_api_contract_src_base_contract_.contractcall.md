...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api-contract/src/base/Contract.ts#L26)*
