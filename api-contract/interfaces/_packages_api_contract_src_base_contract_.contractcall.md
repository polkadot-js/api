...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api-contract/src/base/Contract.ts#L26)*
