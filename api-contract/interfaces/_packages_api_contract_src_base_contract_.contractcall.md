...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/d13e58fb3/packages/api-contract/src/base/Contract.ts#L26)*
