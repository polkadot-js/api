...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/7fd45f63d/packages/api-contract/src/base/Contract.ts#L26)*
