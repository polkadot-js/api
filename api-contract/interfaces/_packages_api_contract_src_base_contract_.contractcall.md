...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/19d6165bd/packages/api-contract/src/base/Contract.ts#L26)*
