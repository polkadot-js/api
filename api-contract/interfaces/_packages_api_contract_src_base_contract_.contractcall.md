...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/cb93cb34b/packages/api-contract/src/base/Contract.ts#L26)*
