...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/eda5edbd4/packages/api-contract/src/base/Contract.ts#L26)*
