...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/b56c1a828/packages/api-contract/src/base/Contract.ts#L26)*
