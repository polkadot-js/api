...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/c6bc664f8/packages/api-contract/src/base/Contract.ts#L26)*
