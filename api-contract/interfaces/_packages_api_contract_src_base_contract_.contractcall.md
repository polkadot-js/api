...
*Defined in [packages/api-contract/src/base/Contract.ts:26](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api-contract/src/base/Contract.ts#L26)*
