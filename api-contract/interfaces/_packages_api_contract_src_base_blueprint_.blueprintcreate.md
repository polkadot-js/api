...
*Defined in [packages/api-contract/src/base/Blueprint.ts:23](https://github.com/polkadot-js/api/blob/014fa123b/packages/api-contract/src/base/Blueprint.ts#L23)*
