...
*Defined in [packages/api-contract/src/base/Blueprint.ts:23](https://github.com/polkadot-js/api/blob/5ce3524cc/packages/api-contract/src/base/Blueprint.ts#L23)*
