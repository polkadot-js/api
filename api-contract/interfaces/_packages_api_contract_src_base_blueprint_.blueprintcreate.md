...
*Defined in [packages/api-contract/src/base/Blueprint.ts:23](https://github.com/polkadot-js/api/blob/cb93cb34b/packages/api-contract/src/base/Blueprint.ts#L23)*
