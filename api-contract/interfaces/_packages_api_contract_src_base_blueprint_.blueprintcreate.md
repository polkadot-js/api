...
*Defined in [packages/api-contract/src/base/Blueprint.ts:23](https://github.com/polkadot-js/api/blob/c27e41be3/packages/api-contract/src/base/Blueprint.ts#L23)*
