...
*Defined in [packages/api-contract/src/base/Blueprint.ts:23](https://github.com/polkadot-js/api/blob/c6bc664f8/packages/api-contract/src/base/Blueprint.ts#L23)*
