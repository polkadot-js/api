...
*Defined in [packages/api-contract/src/base/Contract.ts:29](https://github.com/polkadot-js/api/blob/d3703c072/packages/api-contract/src/base/Contract.ts#L29)*
