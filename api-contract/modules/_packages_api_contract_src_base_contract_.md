...
*Defined in [packages/api-contract/src/base/Contract.ts:29](https://github.com/polkadot-js/api/blob/8631f68ba/packages/api-contract/src/base/Contract.ts#L29)*
