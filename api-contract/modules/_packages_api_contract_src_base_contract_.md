...
*Defined in [packages/api-contract/src/base/Contract.ts:29](https://github.com/polkadot-js/api/blob/cc926596e/packages/api-contract/src/base/Contract.ts#L29)*
