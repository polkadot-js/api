...
*Defined in [packages/api-contract/src/base/Contract.ts:29](https://github.com/polkadot-js/api/blob/014fa123b/packages/api-contract/src/base/Contract.ts#L29)*
