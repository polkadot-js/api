...
*Defined in [packages/api-contract/src/base/Contract.ts:29](https://github.com/polkadot-js/api/blob/7af915185/packages/api-contract/src/base/Contract.ts#L29)*
