...
- [ApiPromise](examples/promise/README.md)
  ...
  - [Generate Accounts](examples/promise/04_generate_account/README.md)
  - [Read Storage](examples/promise/05_read_storage/README.md)
  - [Craft Extrinsic](examples/promise/06_craft_extrinsic/README.md)
  - [Transfer DOTs](examples/promise/07_transfer_dots/README.md)
