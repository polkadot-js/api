...
*__example__*: import createApi from '@polkadot/api'; import WsProvider from '@polkadot/api-provider/ws'; const provider = new WsProvider('ws://127.0.0.1:9944'); const api = createApi(provider);
...
*Defined in [ws/index.ts:67](https://github.com/polkadot-js/api/blob/60d874c/packages/api-provider/src/ws/index.ts#L67)*
...
*Defined in [ws/index.ts:97](https://github.com/polkadot-js/api/blob/60d874c/packages/api-provider/src/ws/index.ts#L97)*
...
*Defined in [ws/index.ts:114](https://github.com/polkadot-js/api/blob/60d874c/packages/api-provider/src/ws/index.ts#L114)*
...
*Defined in [ws/index.ts:124](https://github.com/polkadot-js/api/blob/60d874c/packages/api-provider/src/ws/index.ts#L124)*
...
*Defined in [ws/index.ts:128](https://github.com/polkadot-js/api/blob/60d874c/packages/api-provider/src/ws/index.ts#L128)*
...
*Defined in [ws/index.ts:179](https://github.com/polkadot-js/api/blob/60d874c/packages/api-provider/src/ws/index.ts#L179)*

Allows subscribing to a specific event.
*__example__*: const provider = new WsProvider('ws://127.0.0.1:9944'); const api = createApi(provider);
...
*Defined in [ws/index.ts:188](https://github.com/polkadot-js/api/blob/60d874c/packages/api-provider/src/ws/index.ts#L188)*
