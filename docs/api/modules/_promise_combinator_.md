...
*Defined in [promise/Combinator.ts:9](https://github.com/polkadot-js/api/blob/9a56f1b/packages/api/src/promise/Combinator.ts#L9)*
...
*Defined in [promise/Combinator.ts:10](https://github.com/polkadot-js/api/blob/9a56f1b/packages/api/src/promise/Combinator.ts#L10)*
