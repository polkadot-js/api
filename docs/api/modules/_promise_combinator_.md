...
*Defined in [promise/Combinator.ts:7](https://github.com/polkadot-js/api/blob/ed8c2e3/packages/api/src/promise/Combinator.ts#L7)*
...
*Defined in [promise/Combinator.ts:8](https://github.com/polkadot-js/api/blob/ed8c2e3/packages/api/src/promise/Combinator.ts#L8)*
