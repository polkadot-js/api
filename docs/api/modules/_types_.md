...
*Defined in [types.ts:10](https://github.com/polkadot-js/api/blob/f655634/packages/api/src/types.ts#L10)*
...
*Defined in [types.ts:38](https://github.com/polkadot-js/api/blob/f655634/packages/api/src/types.ts#L38)*
