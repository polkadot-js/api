...
*Defined in [types.ts:10](https://github.com/polkadot-js/api/blob/f6c93e4/packages/api/src/types.ts#L10)*
...
*Defined in [types.ts:38](https://github.com/polkadot-js/api/blob/f6c93e4/packages/api/src/types.ts#L38)*
