...
*Defined in [types.ts:10](https://github.com/polkadot-js/api/blob/e177727/packages/api/src/types.ts#L10)*
...
*Defined in [types.ts:38](https://github.com/polkadot-js/api/blob/e177727/packages/api/src/types.ts#L38)*
