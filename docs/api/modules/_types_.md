...
*Defined in [types.ts:10](https://github.com/polkadot-js/api/blob/54eada5/packages/api/src/types.ts#L10)*
...
*Defined in [types.ts:38](https://github.com/polkadot-js/api/blob/54eada5/packages/api/src/types.ts#L38)*
