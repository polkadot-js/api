...
*Defined in [types.ts:10](https://github.com/polkadot-js/api/blob/4f55d19/packages/api/src/types.ts#L10)*
...
*Defined in [types.ts:38](https://github.com/polkadot-js/api/blob/4f55d19/packages/api/src/types.ts#L38)*
