...
*Defined in [types.ts:10](https://github.com/polkadot-js/api/blob/85434e0/packages/api/src/types.ts#L10)*
...
*Defined in [types.ts:37](https://github.com/polkadot-js/api/blob/85434e0/packages/api/src/types.ts#L37)*
