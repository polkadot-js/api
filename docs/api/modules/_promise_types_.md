...
*Defined in [promise/types.ts:15](https://github.com/polkadot-js/api/blob/1edf7a0/packages/api/src/promise/types.ts#L15)*
...
*Defined in [promise/types.ts:13](https://github.com/polkadot-js/api/blob/1edf7a0/packages/api/src/promise/types.ts#L13)*
