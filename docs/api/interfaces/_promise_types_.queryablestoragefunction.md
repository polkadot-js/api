...
*Defined in [promise/types.ts:15](https://github.com/polkadot-js/api/blob/919a73c/packages/api/src/promise/types.ts#L15)*
...
*Defined in [promise/types.ts:17](https://github.com/polkadot-js/api/blob/919a73c/packages/api/src/promise/types.ts#L17)*
