...
*Defined in [promise/types.ts:15](https://github.com/polkadot-js/api/blob/77a9d8e/packages/api/src/promise/types.ts#L15)*
...
*Defined in [promise/types.ts:17](https://github.com/polkadot-js/api/blob/77a9d8e/packages/api/src/promise/types.ts#L17)*
