...
*Defined in [types.ts:166](https://github.com/polkadot-js/api/blob/40a1ec9/packages/api/src/types.ts#L166)*
...
*Defined in [types.ts:161](https://github.com/polkadot-js/api/blob/40a1ec9/packages/api/src/types.ts#L161)*
