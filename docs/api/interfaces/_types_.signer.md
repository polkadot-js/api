...
*Defined in [types.ts:152](https://github.com/polkadot-js/api/blob/15b22da/packages/api/src/types.ts#L152)*
...
*Defined in [types.ts:147](https://github.com/polkadot-js/api/blob/15b22da/packages/api/src/types.ts#L147)*
