...
*Defined in [types.ts:152](https://github.com/polkadot-js/api/blob/4e8bc10/packages/api/src/types.ts#L152)*
...
*Defined in [types.ts:147](https://github.com/polkadot-js/api/blob/4e8bc10/packages/api/src/types.ts#L147)*
