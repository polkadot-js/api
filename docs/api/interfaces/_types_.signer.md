...
*Defined in [types.ts:152](https://github.com/polkadot-js/api/blob/ead67ec/packages/api/src/types.ts#L152)*
...
*Defined in [types.ts:147](https://github.com/polkadot-js/api/blob/ead67ec/packages/api/src/types.ts#L147)*
