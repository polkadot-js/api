...
*Defined in [types.ts:171](https://github.com/polkadot-js/api/blob/f4119bf/packages/api/src/types.ts#L171)*
...
*Defined in [types.ts:166](https://github.com/polkadot-js/api/blob/f4119bf/packages/api/src/types.ts#L166)*
