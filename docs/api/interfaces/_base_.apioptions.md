...
*Defined in [Base.ts:42](https://github.com/polkadot-js/api/blob/6cab9be/packages/api/src/Base.ts#L42)*
...
*Defined in [Base.ts:38](https://github.com/polkadot-js/api/blob/6cab9be/packages/api/src/Base.ts#L38)*
