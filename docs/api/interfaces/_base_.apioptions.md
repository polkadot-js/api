...
*Defined in [Base.ts:42](https://github.com/polkadot-js/api/blob/637182b/packages/api/src/Base.ts#L42)*
...
*Defined in [Base.ts:38](https://github.com/polkadot-js/api/blob/637182b/packages/api/src/Base.ts#L38)*
