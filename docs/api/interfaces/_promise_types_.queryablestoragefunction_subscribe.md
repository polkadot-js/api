...
*Defined in [promise/types.ts:28](https://github.com/polkadot-js/api/blob/2a2df9a/packages/api/src/promise/types.ts#L28)*
...
*Defined in [promise/types.ts:29](https://github.com/polkadot-js/api/blob/2a2df9a/packages/api/src/promise/types.ts#L29)*
