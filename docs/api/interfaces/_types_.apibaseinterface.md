...
*Defined in [types.ts:140](https://github.com/polkadot-js/api/blob/7792663/packages/api/src/types.ts#L140)*
...
*Defined in [types.ts:141](https://github.com/polkadot-js/api/blob/7792663/packages/api/src/types.ts#L141)*
...
*Defined in [types.ts:138](https://github.com/polkadot-js/api/blob/7792663/packages/api/src/types.ts#L138)*
