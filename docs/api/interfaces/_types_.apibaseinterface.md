...
*Defined in [types.ts:100](https://github.com/polkadot-js/api/blob/a3e421f/packages/api/src/types.ts#L100)*
...
*Defined in [types.ts:101](https://github.com/polkadot-js/api/blob/a3e421f/packages/api/src/types.ts#L101)*
