...
*Defined in [types.ts:139](https://github.com/polkadot-js/api/blob/89c6289/packages/api/src/types.ts#L139)*
...
*Defined in [types.ts:140](https://github.com/polkadot-js/api/blob/89c6289/packages/api/src/types.ts#L140)*
...
*Defined in [types.ts:137](https://github.com/polkadot-js/api/blob/89c6289/packages/api/src/types.ts#L137)*
