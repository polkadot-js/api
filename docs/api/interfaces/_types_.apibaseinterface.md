...
*Defined in [types.ts:158](https://github.com/polkadot-js/api/blob/5f98849/packages/api/src/types.ts#L158)*
...
*Defined in [types.ts:159](https://github.com/polkadot-js/api/blob/5f98849/packages/api/src/types.ts#L159)*
...
*Defined in [types.ts:156](https://github.com/polkadot-js/api/blob/5f98849/packages/api/src/types.ts#L156)*
