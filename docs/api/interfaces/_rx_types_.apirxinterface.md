...
*Defined in [Base.ts:71](https://github.com/polkadot-js/api/blob/f957639/packages/api/src/Base.ts#L71)*
...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/f957639/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/f957639/packages/api/src/rx/types.ts#L14)*
