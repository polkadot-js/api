...
*Defined in [Base.ts:72](https://github.com/polkadot-js/api/blob/8beac7b/packages/api/src/Base.ts#L72)*
...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/8beac7b/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/8beac7b/packages/api/src/rx/types.ts#L14)*
