...
*Defined in [Base.ts:68](https://github.com/polkadot-js/api/blob/767a197/packages/api/src/Base.ts#L68)*
...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/767a197/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/767a197/packages/api/src/rx/types.ts#L14)*
