...
*Defined in [types.ts:13](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L13)*
...
*Defined in [types.ts:14](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L14)*
...
*Defined in [rx/types.ts:42](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/rx/types.ts#L42)*
...
*Defined in [rx/types.ts:43](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/rx/types.ts#L43)*
...
*Defined in [types.ts:21](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L21)*
...
*Defined in [types.ts:22](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L22)*
...
*Defined in [types.ts:17](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L17)*
...
*Defined in [types.ts:18](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L18)*
...
*Defined in [types.ts:15](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L15)*
...
*Defined in [types.ts:16](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L16)*
...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/2751491/packages/api/src/types.ts#L19)*
