...
*Defined in [rx/types.ts:42](https://github.com/polkadot-js/api/blob/dfac7a4/packages/api/src/rx/types.ts#L42)*
...
*Defined in [rx/types.ts:43](https://github.com/polkadot-js/api/blob/dfac7a4/packages/api/src/rx/types.ts#L43)*
