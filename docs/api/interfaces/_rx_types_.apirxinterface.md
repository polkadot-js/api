...
*Defined in [rx/types.ts:40](https://github.com/polkadot-js/api/blob/82dcbe5/packages/api/src/rx/types.ts#L40)*
...
*Defined in [rx/types.ts:41](https://github.com/polkadot-js/api/blob/82dcbe5/packages/api/src/rx/types.ts#L41)*
