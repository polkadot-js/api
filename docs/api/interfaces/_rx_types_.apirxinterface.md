...
*Defined in [types.ts:13](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L13)*
...
*Defined in [types.ts:14](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L14)*
...
*Defined in [rx/types.ts:40](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/rx/types.ts#L40)*
...
*Defined in [rx/types.ts:41](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/rx/types.ts#L41)*
...
*Defined in [types.ts:21](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L21)*
...
*Defined in [types.ts:17](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L17)*
...
*Defined in [types.ts:18](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L18)*
...
*Defined in [types.ts:15](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L15)*
...
*Defined in [types.ts:16](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L16)*
...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/04c639d/packages/api/src/types.ts#L19)*
