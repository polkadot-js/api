...
*Defined in [types.ts:12](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/types.ts#L12)*
...
*Defined in [rx/types.ts:40](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/rx/types.ts#L40)*
...
*Defined in [rx/types.ts:41](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/rx/types.ts#L41)*
...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/types.ts#L19)*
...
*Defined in [types.ts:15](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/types.ts#L15)*
...
*Defined in [types.ts:16](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/types.ts#L16)*
...
*Defined in [types.ts:13](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/types.ts#L13)*
...
*Defined in [types.ts:14](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/types.ts#L14)*
...
*Defined in [types.ts:17](https://github.com/polkadot-js/api/blob/9092250/packages/api/src/types.ts#L17)*
