...
*Defined in [rx/types.ts:40](https://github.com/polkadot-js/api/blob/6cab9be/packages/api/src/rx/types.ts#L40)*
...
*Defined in [rx/types.ts:41](https://github.com/polkadot-js/api/blob/6cab9be/packages/api/src/rx/types.ts#L41)*
