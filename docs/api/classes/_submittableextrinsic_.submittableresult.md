...
*Defined in [SubmittableExtrinsic.ts:28](https://github.com/polkadot-js/api/blob/f807a93/packages/api/src/SubmittableExtrinsic.ts#L28)*
...
*Defined in [SubmittableExtrinsic.ts:40](https://github.com/polkadot-js/api/blob/f807a93/packages/api/src/SubmittableExtrinsic.ts#L40)*
...
*Defined in [SubmittableExtrinsic.ts:47](https://github.com/polkadot-js/api/blob/f807a93/packages/api/src/SubmittableExtrinsic.ts#L47)*
...
*Defined in [SubmittableExtrinsic.ts:54](https://github.com/polkadot-js/api/blob/f807a93/packages/api/src/SubmittableExtrinsic.ts#L54)*
