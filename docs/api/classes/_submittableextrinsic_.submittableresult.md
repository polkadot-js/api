...
*Defined in [SubmittableExtrinsic.ts:36](https://github.com/polkadot-js/api/blob/d16671c/packages/api/src/SubmittableExtrinsic.ts#L36)*
...
*Defined in [SubmittableExtrinsic.ts:48](https://github.com/polkadot-js/api/blob/d16671c/packages/api/src/SubmittableExtrinsic.ts#L48)*
...
*Defined in [SubmittableExtrinsic.ts:55](https://github.com/polkadot-js/api/blob/d16671c/packages/api/src/SubmittableExtrinsic.ts#L55)*
...
*Defined in [SubmittableExtrinsic.ts:62](https://github.com/polkadot-js/api/blob/d16671c/packages/api/src/SubmittableExtrinsic.ts#L62)*
