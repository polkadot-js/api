...
*Defined in [rx/SubmittableExtrinsic.ts:13](https://github.com/polkadot-js/api/blob/1b7640f/packages/api/src/rx/SubmittableExtrinsic.ts#L13)*
...
*Defined in [rx/SubmittableExtrinsic.ts:21](https://github.com/polkadot-js/api/blob/1b7640f/packages/api/src/rx/SubmittableExtrinsic.ts#L21)*
...
*Defined in [rx/SubmittableExtrinsic.ts:25](https://github.com/polkadot-js/api/blob/1b7640f/packages/api/src/rx/SubmittableExtrinsic.ts#L25)*
