...
⊕ **new ApiPromise**(options?: * [ApiOptions](../interfaces/_base_.apioptions.md) &#124; `WsProvider`*): [ApiPromise](_promise_index_.apipromise.md)

*Overrides [ApiBase](_base_.apibase.md).[constructor](_base_.apibase.md#constructor)*

*Defined in [promise/index.ts:128](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/promise/index.ts#L128)*
...
| ------ | ------ | ------ | ------ |
| `Default value` options |  [ApiOptions](../interfaces/_base_.apioptions.md) &#124; `WsProvider`|  {} |  Options to create an instance. Can be either [ApiOptions](../interfaces/_base_.apioptions.md) or \[\[WsProvider\]\] |
...
*Defined in [Base.ts:88](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/Base.ts#L88)*
...
*Defined in [promise/index.ts:166](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/promise/index.ts#L166)*
...
*Defined in [Base.ts:126](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/Base.ts#L126)*
...
*Defined in [Base.ts:146](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/Base.ts#L146)*
...
*Defined in [Base.ts:97](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/Base.ts#L97)*
...
*Defined in [Base.ts:106](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/Base.ts#L106)*
...
*Defined in [Base.ts:165](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/Base.ts#L165)*
...
*Defined in [promise/index.ts:194](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/promise/index.ts#L194)*
...
*Defined in [Base.ts:190](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/Base.ts#L190)*
...
▸ **create**(options?: * [ApiOptions](../interfaces/_base_.apioptions.md) &#124; `WsProvider`*): `Promise`<[ApiPromise](_promise_index_.apipromise.md)>

*Defined in [promise/index.ts:126](https://github.com/polkadot-js/api/blob/101f869/packages/api/src/promise/index.ts#L126)*
...
| Name | Type | Default value | Description |
| ------ | ------ | ------ | ------ |
| `Default value` options |  [ApiOptions](../interfaces/_base_.apioptions.md) &#124; `WsProvider`|  {} |  options that is passed to the class contructor. Can be either [ApiOptions](../interfaces/_base_.apioptions.md) or \[\[WsProvider\]\] |
