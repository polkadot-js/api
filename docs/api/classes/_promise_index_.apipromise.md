...
*Defined in [promise/index.ts:138](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/promise/index.ts#L138)*
...
*Defined in [Base.ts:77](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L77)*
...
*Defined in [Base.ts:86](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L86)*
...
*Defined in [promise/index.ts:177](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/promise/index.ts#L177)*
...
*Defined in [Base.ts:122](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L122)*
...
*Defined in [Base.ts:142](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L142)*
...
*Defined in [Base.ts:93](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L93)*
...
*Defined in [Base.ts:102](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L102)*
...
*Defined in [Base.ts:161](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L161)*
...
▸ **combineLatest**(fns: *`Array`<[CombinatorFunction](../modules/_promise_combinator_.md#combinatorfunction) | [`Array`<`any`>, [CombinatorFunction](../modules/_promise_combinator_.md#combinatorfunction)]>*, callback: *[CombinatorCallback](../modules/_promise_combinator_.md#combinatorcallback)*): [UnsubFunction](../modules/_promise_types_.md#unsubfunction)

*Defined in [promise/index.ts:248](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/promise/index.ts#L248)*
...
| Name | Type | Description |
| ------ | ------ | ------ |
| fns | `Array`<[CombinatorFunction](../modules/_promise_combinator_.md#combinatorfunction) | [`Array`<`any`>, [CombinatorFunction](../modules/_promise_combinator_.md#combinatorfunction)]> |  An array of function to combine, each in the form of \`(cb: (value: void)) => void\` |
...
*Defined in [Base.ts:186](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L186)*
...
*Defined in [Base.ts:210](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/Base.ts#L210)*
...
*Defined in [promise/index.ts:136](https://github.com/polkadot-js/api/blob/95af8db/packages/api/src/promise/index.ts#L136)*
