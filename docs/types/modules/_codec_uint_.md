...
*Defined in [codec/UInt.ts:13](https://github.com/polkadot-js/api/blob/d5bca16/packages/types/src/codec/UInt.ts#L13)*
...
*Defined in [codec/UInt.ts:15](https://github.com/polkadot-js/api/blob/d5bca16/packages/types/src/codec/UInt.ts#L15)*
