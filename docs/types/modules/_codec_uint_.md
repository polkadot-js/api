...
*Defined in [codec/UInt.ts:13](https://github.com/polkadot-js/api/blob/cb9a48d/packages/types/src/codec/UInt.ts#L13)*
...
*Defined in [codec/UInt.ts:15](https://github.com/polkadot-js/api/blob/cb9a48d/packages/types/src/codec/UInt.ts#L15)*
