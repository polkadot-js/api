...
*Defined in [codec/UInt.ts:10](https://github.com/polkadot-js/api/blob/82dcbe5/packages/types/src/codec/UInt.ts#L10)*
...
*Defined in [codec/UInt.ts:12](https://github.com/polkadot-js/api/blob/82dcbe5/packages/types/src/codec/UInt.ts#L12)*
