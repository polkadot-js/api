...
*Defined in [codec/UInt.ts:19](https://github.com/polkadot-js/api/blob/e8e92cd/packages/types/src/codec/UInt.ts#L19)*
...
*Defined in [codec/UInt.ts:21](https://github.com/polkadot-js/api/blob/e8e92cd/packages/types/src/codec/UInt.ts#L21)*
