...
*Defined in [codec/UInt.ts:19](https://github.com/polkadot-js/api/blob/1e9b69c/packages/types/src/codec/UInt.ts#L19)*
...
*Defined in [codec/UInt.ts:21](https://github.com/polkadot-js/api/blob/1e9b69c/packages/types/src/codec/UInt.ts#L21)*
