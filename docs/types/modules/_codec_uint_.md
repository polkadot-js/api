...
*Defined in [codec/UInt.ts:19](https://github.com/polkadot-js/api/blob/4ff2b2d/packages/types/src/codec/UInt.ts#L19)*
...
*Defined in [codec/UInt.ts:21](https://github.com/polkadot-js/api/blob/4ff2b2d/packages/types/src/codec/UInt.ts#L21)*
