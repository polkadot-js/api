...
*Defined in [codec/UInt.ts:13](https://github.com/polkadot-js/api/blob/f6506db/packages/types/src/codec/UInt.ts#L13)*
...
*Defined in [codec/UInt.ts:15](https://github.com/polkadot-js/api/blob/f6506db/packages/types/src/codec/UInt.ts#L15)*
