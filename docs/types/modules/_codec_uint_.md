...
*Defined in [codec/UInt.ts:12](https://github.com/polkadot-js/api/blob/1d3eecd/packages/types/src/codec/UInt.ts#L12)*
...
*Defined in [codec/UInt.ts:14](https://github.com/polkadot-js/api/blob/1d3eecd/packages/types/src/codec/UInt.ts#L14)*
