...
*Defined in [type/StoredPendingChange.ts:14](https://github.com/polkadot-js/api/blob/6eb859c/packages/types/src/type/StoredPendingChange.ts#L14)*
...
*Defined in [type/StoredPendingChange.ts:19](https://github.com/polkadot-js/api/blob/6eb859c/packages/types/src/type/StoredPendingChange.ts#L19)*
