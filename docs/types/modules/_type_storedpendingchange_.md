...
*Defined in [type/StoredPendingChange.ts:14](https://github.com/polkadot-js/api/blob/8a946ae/packages/types/src/type/StoredPendingChange.ts#L14)*
...
*Defined in [type/StoredPendingChange.ts:19](https://github.com/polkadot-js/api/blob/8a946ae/packages/types/src/type/StoredPendingChange.ts#L19)*
