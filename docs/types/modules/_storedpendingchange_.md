...
*Defined in [StoredPendingChange.ts:15](https://github.com/polkadot-js/api/blob/89c6289/packages/types/src/StoredPendingChange.ts#L15)*
...
*Defined in [StoredPendingChange.ts:20](https://github.com/polkadot-js/api/blob/89c6289/packages/types/src/StoredPendingChange.ts#L20)*
