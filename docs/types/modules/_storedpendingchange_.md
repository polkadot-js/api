...
*Defined in [StoredPendingChange.ts:15](https://github.com/polkadot-js/api/blob/9a49732/packages/types/src/StoredPendingChange.ts#L15)*
...
*Defined in [StoredPendingChange.ts:20](https://github.com/polkadot-js/api/blob/9a49732/packages/types/src/StoredPendingChange.ts#L20)*
