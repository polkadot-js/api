...
*__description__*: This is a string wrapper, along with the length. It is used both for strings as well as items such as documentation.
...
*Defined in [Text.ts:21](https://github.com/polkadot-js/api/blob/6cab9be/packages/types/src/Text.ts#L21)*
...
*Defined in [Text.ts:42](https://github.com/polkadot-js/api/blob/6cab9be/packages/types/src/Text.ts#L42)*
...
*Defined in [Text.ts:54](https://github.com/polkadot-js/api/blob/6cab9be/packages/types/src/Text.ts#L54)*
