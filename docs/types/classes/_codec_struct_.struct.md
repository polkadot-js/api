...
↳  [PrefabWasmModule](_prefabwasmmodule_.prefabwasmmodule.md)
...
↳  [VestingSchedule](_vestingschedule_.vestingschedule.md)
...
*Defined in [codec/Struct.ts:31](https://github.com/polkadot-js/api/blob/b846152/packages/types/src/codec/Struct.ts#L31)*
