...
*Defined in [Header.ts:29](https://github.com/polkadot-js/api/blob/3e20e7b/packages/types/src/Header.ts#L29)*
...
*Defined in [Header.ts:36](https://github.com/polkadot-js/api/blob/3e20e7b/packages/types/src/Header.ts#L36)*
