...
*__description__*: Parts per million (See also [Perbill](_perbill_.perbill.md))
...
⊕ **new Permill**(value?: *[AnyNumber](../modules/_types_.md#anynumber)*): [Permill](_permill_.permill.md)

*Inherited from [U32](_u32_.u32.md).[constructor](_u32_.u32.md#constructor)*

*Overrides [UInt](_codec_uint_.uint.md).[constructor](_codec_uint_.uint.md#constructor)*

*Defined in [U32.ts:14](https://github.com/polkadot-js/api/blob/5a0d692/packages/types/src/U32.ts#L14)*
