...
⊕ **new AuthoritiesChange**(Type: *[Constructor](../modules/_types_.md#constructor)<`T`>*, value?: *[Vector](_codec_vector_.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [AuthoritiesChange](_type_digest_.authoritieschange.md)
