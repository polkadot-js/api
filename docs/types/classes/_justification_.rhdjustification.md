...
*Defined in [Justification.ts:33](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/Justification.ts#L33)*
...
*Defined in [Justification.ts:47](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/Justification.ts#L47)*
...
*Defined in [Justification.ts:54](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/Justification.ts#L54)*
...
*Defined in [Justification.ts:61](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/Justification.ts#L61)*
