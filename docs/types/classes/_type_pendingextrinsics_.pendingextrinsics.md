...
⊕ **new PendingExtrinsics**(Type: *[Constructor](../interfaces/_types_.constructor.md)<`T`>*, value?: *[Vector](_codec_vector_.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [PendingExtrinsics](_type_pendingextrinsics_.pendingextrinsics.md)
...
**Returns:** [PendingExtrinsics](_type_pendingextrinsics_.pendingextrinsics.md)
