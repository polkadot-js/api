...
↳  [RuntimeVersionApi](_type_runtimeversion_.runtimeversionapi.md)
...
*Defined in [codec/Tuple.ts:22](https://github.com/polkadot-js/api/blob/5f98849/packages/types/src/codec/Tuple.ts#L22)*
