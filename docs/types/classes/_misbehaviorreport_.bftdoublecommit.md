...
*Defined in [MisbehaviorReport.ts:27](https://github.com/polkadot-js/api/blob/12a3b4a/packages/types/src/MisbehaviorReport.ts#L27)*
...
*Defined in [MisbehaviorReport.ts:36](https://github.com/polkadot-js/api/blob/12a3b4a/packages/types/src/MisbehaviorReport.ts#L36)*
...
*Defined in [MisbehaviorReport.ts:40](https://github.com/polkadot-js/api/blob/12a3b4a/packages/types/src/MisbehaviorReport.ts#L40)*
...
*Defined in [MisbehaviorReport.ts:44](https://github.com/polkadot-js/api/blob/12a3b4a/packages/types/src/MisbehaviorReport.ts#L44)*
