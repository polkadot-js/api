...
*Defined in [MisbehaviorReport.ts:33](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/MisbehaviorReport.ts#L33)*
...
*Defined in [MisbehaviorReport.ts:45](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/MisbehaviorReport.ts#L45)*
...
*Defined in [MisbehaviorReport.ts:52](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/MisbehaviorReport.ts#L52)*
...
*Defined in [MisbehaviorReport.ts:59](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/MisbehaviorReport.ts#L59)*
