...
*Defined in [MisbehaviorReport.ts:57](https://github.com/polkadot-js/api/blob/076e552/packages/types/src/MisbehaviorReport.ts#L57)*
...
▸ **fromJSON**(input?: *`any`*): [EnumType](_codec_enumtype_.enumtype.md)< [BftDoublePrepare](_misbehaviorreport_.bftdoubleprepare.md) &#124; [BftDoubleCommit](_misbehaviorreport_.bftdoublecommit.md)>
...
*Defined in [codec/EnumType.ts:144](https://github.com/polkadot-js/api/blob/076e552/packages/types/src/codec/EnumType.ts#L144)*
