...
*Defined in [MisbehaviorReport.ts:57](https://github.com/polkadot-js/api/blob/d2eb6e5/packages/types/src/MisbehaviorReport.ts#L57)*
...
*Defined in [codec/EnumType.ts:115](https://github.com/polkadot-js/api/blob/d2eb6e5/packages/types/src/codec/EnumType.ts#L115)*
