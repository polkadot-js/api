...
*Defined in [MisbehaviorReport.ts:57](https://github.com/polkadot-js/api/blob/51d4c45/packages/types/src/MisbehaviorReport.ts#L57)*
...
*Defined in [codec/EnumType.ts:80](https://github.com/polkadot-js/api/blob/51d4c45/packages/types/src/codec/EnumType.ts#L80)*
