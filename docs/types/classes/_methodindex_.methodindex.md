...
*Defined in [MethodIndex.ts:9](https://github.com/polkadot-js/api/blob/3a7cddd/packages/types/src/MethodIndex.ts#L9)*
...
*Defined in [codec/U8aFixed.ts:44](https://github.com/polkadot-js/api/blob/3a7cddd/packages/types/src/codec/U8aFixed.ts#L44)*
