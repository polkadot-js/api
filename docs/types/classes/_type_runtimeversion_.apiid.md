...
⊕ **new ApiId**(value?: *[AnyU8a](../modules/_types_.md#anyu8a)*): [ApiId](_type_runtimeversion_.apiid.md)

*Overrides [U8aFixed](_codec_u8afixed_.u8afixed.md).[constructor](_codec_u8afixed_.u8afixed.md#constructor)*

*Defined in [type/RuntimeVersion.ts:19](https://github.com/polkadot-js/api/blob/8a946ae/packages/types/src/type/RuntimeVersion.ts#L19)*
