...
↳  [PendingExtrinsics](_type_pendingextrinsics_.pendingextrinsics.md)
...
⊕ **new Extrinsics**(Type: *[Constructor](../modules/_types_.md#constructor)<`T`>*, value?: *[Vector](_codec_vector_.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [Extrinsics](_type_extrinsics_.extrinsics.md)
