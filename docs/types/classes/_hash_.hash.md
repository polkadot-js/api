...
*__description__*: The default hash that is used accross the system. It is basically just a thin wrapper around [H256](_h256_.h256.md), representing a 32-byte blake2b (Substrate) value
...
↳  [ChangesTrieRoot](_digest_.changestrieroot.md)

↳  [CodeHash](_codehash_.codehash.md)

↳  [Finalised](_extrinsicstatus_.finalised.md)

↳  [Usurped](_extrinsicstatus_.usurped.md)

↳  [SeedOf](_seedof_.seedof.md)
...
*Defined in [H256.ts:15](https://github.com/polkadot-js/api/blob/b846152/packages/types/src/H256.ts#L15)*
