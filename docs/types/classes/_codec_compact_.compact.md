...
*Defined in [codec/Compact.ts:38](https://github.com/polkadot-js/api/blob/12a3b4a/packages/types/src/codec/Compact.ts#L38)*
...
*Defined in [codec/Compact.ts:55](https://github.com/polkadot-js/api/blob/12a3b4a/packages/types/src/codec/Compact.ts#L55)*
