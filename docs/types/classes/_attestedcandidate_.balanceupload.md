...
⊕ **new BalanceUpload**(Types: *`TupleConstructors`*, value: *`any`*): [BalanceUpload](_attestedcandidate_.balanceupload.md)
...
**Returns:** [BalanceUpload](_attestedcandidate_.balanceupload.md)
