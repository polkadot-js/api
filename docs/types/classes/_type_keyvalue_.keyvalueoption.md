...
*__description__*: A key/value change. This is similar to the [KeyValue](_type_keyvalue_.keyvalue.md) structure, however in this case the value could be optional. Here it extends from a [Tuple](_codec_tuple_.tuple.md), indicating the use inside areas such as [StorageChangeSet](_type_storagechangeset_.storagechangeset.md)
...
*Defined in [type/KeyValue.ts:58](https://github.com/polkadot-js/api/blob/447ab2f/packages/types/src/type/KeyValue.ts#L58)*
...
*Defined in [type/KeyValue.ts:69](https://github.com/polkadot-js/api/blob/447ab2f/packages/types/src/type/KeyValue.ts#L69)*
...
getvalue(): [Option](_codec_option_.option.md)<[StorageData](_primitive_storagedata_.storagedata.md)>

*Defined in [type/KeyValue.ts:76](https://github.com/polkadot-js/api/blob/447ab2f/packages/types/src/type/KeyValue.ts#L76)*
