...
*Defined in [Event.ts:27](https://github.com/polkadot-js/api/blob/1e88075/packages/types/src/Event.ts#L27)*
...
*Defined in [Event.ts:41](https://github.com/polkadot-js/api/blob/1e88075/packages/types/src/Event.ts#L41)*
...
*Defined in [Event.ts:48](https://github.com/polkadot-js/api/blob/1e88075/packages/types/src/Event.ts#L48)*
...
*Defined in [Event.ts:55](https://github.com/polkadot-js/api/blob/1e88075/packages/types/src/Event.ts#L55)*
...
*Defined in [Event.ts:62](https://github.com/polkadot-js/api/blob/1e88075/packages/types/src/Event.ts#L62)*
