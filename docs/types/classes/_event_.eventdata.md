...
*Defined in [Event.ts:28](https://github.com/polkadot-js/api/blob/9a49732/packages/types/src/Event.ts#L28)*
...
*Defined in [Event.ts:42](https://github.com/polkadot-js/api/blob/9a49732/packages/types/src/Event.ts#L42)*
...
*Defined in [Event.ts:49](https://github.com/polkadot-js/api/blob/9a49732/packages/types/src/Event.ts#L49)*
...
*Defined in [Event.ts:56](https://github.com/polkadot-js/api/blob/9a49732/packages/types/src/Event.ts#L56)*
...
*Defined in [Event.ts:63](https://github.com/polkadot-js/api/blob/9a49732/packages/types/src/Event.ts#L63)*
