...
*__description__*: Parts per billion (see also [Permill](_permill_.permill.md))
...
⊕ **new Perbill**(value?: *[AnyNumber](../modules/_types_.md#anynumber)*): [Perbill](_perbill_.perbill.md)
