...
*Defined in [StoredPendingChange.ts:53](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/StoredPendingChange.ts#L53)*
...
*Defined in [StoredPendingChange.ts:65](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/StoredPendingChange.ts#L65)*
...
*Defined in [StoredPendingChange.ts:69](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/StoredPendingChange.ts#L69)*
...
*Defined in [StoredPendingChange.ts:73](https://github.com/polkadot-js/api/blob/04c639d/packages/types/src/StoredPendingChange.ts#L73)*
