...
*Defined in [classes.ts:31](https://github.com/polkadot-js/api/blob/64c5868/packages/api-observable/src/classes.ts#L31)*
...
*Defined in [classes.ts:39](https://github.com/polkadot-js/api/blob/64c5868/packages/api-observable/src/classes.ts#L39)*
...
*Defined in [classes.ts:43](https://github.com/polkadot-js/api/blob/64c5868/packages/api-observable/src/classes.ts#L43)*
