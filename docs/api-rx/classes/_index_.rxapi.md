...
*Defined in [index.ts:46](https://github.com/polkadot-js/api/blob/5a770c7/packages/api-rx/src/index.ts#L46)*
...
*Defined in [index.ts:43](https://github.com/polkadot-js/api/blob/5a770c7/packages/api-rx/src/index.ts#L43)*
...
*Defined in [index.ts:44](https://github.com/polkadot-js/api/blob/5a770c7/packages/api-rx/src/index.ts#L44)*
...
*Defined in [index.ts:45](https://github.com/polkadot-js/api/blob/5a770c7/packages/api-rx/src/index.ts#L45)*
...
*Defined in [index.ts:65](https://github.com/polkadot-js/api/blob/5a770c7/packages/api-rx/src/index.ts#L65)*
