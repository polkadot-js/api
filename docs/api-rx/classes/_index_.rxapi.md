...
*Defined in [index.ts:40](https://github.com/polkadot-js/api/blob/59e9783/packages/api-rx/src/index.ts#L40)*
...
*Defined in [index.ts:37](https://github.com/polkadot-js/api/blob/59e9783/packages/api-rx/src/index.ts#L37)*
...
*Defined in [index.ts:38](https://github.com/polkadot-js/api/blob/59e9783/packages/api-rx/src/index.ts#L38)*
...
*Defined in [index.ts:39](https://github.com/polkadot-js/api/blob/59e9783/packages/api-rx/src/index.ts#L39)*
...
*Defined in [index.ts:59](https://github.com/polkadot-js/api/blob/59e9783/packages/api-rx/src/index.ts#L59)*
