...
*Defined in [index.ts:44](https://github.com/polkadot-js/api/blob/8cf0201/packages/api-rx/src/index.ts#L44)*
...
*Defined in [index.ts:41](https://github.com/polkadot-js/api/blob/8cf0201/packages/api-rx/src/index.ts#L41)*
...
*Defined in [index.ts:42](https://github.com/polkadot-js/api/blob/8cf0201/packages/api-rx/src/index.ts#L42)*
...
*Defined in [index.ts:43](https://github.com/polkadot-js/api/blob/8cf0201/packages/api-rx/src/index.ts#L43)*
...
*Defined in [index.ts:63](https://github.com/polkadot-js/api/blob/8cf0201/packages/api-rx/src/index.ts#L63)*
