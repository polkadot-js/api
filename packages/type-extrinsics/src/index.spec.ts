...
describe('extrinsics', () => {
  ...
  it('encodes an actual transfer (actual data)', () => {
    expect(
      ...
      '9469a2a5828aef01834507dd320c89561675c3a85ea6318f4ea922f7a16386cc' + // sig1
      '5fcd2f0ed85fbedc180d4bdaac89e5560bf66f50ccc0d50d65f5e64121158106' + // sig2
      '0000' + // nonce
      '0200' + // balances.transfer
