  ...
  describe('toU8a', (): void => {
    ...
    it('has a sane inspect', (): void => {
      expect(
        ...
        inner: [
          { inner: [{ inner: [], value: new Uint8Array([0x42, 0x69]) }], value: new Uint8Array([2 << 2]) },
          { inner: [{ inner: [], value: new Uint8Array([0x99]) }], value: new Uint8Array([1 << 2]) },
          { inner: [{ inner: [], value: new Uint8Array([1, 0, 0, 0]) }], value: new Uint8Array([1]) },
          { inner: [], value: new Uint8Array([1]) }
        ],
