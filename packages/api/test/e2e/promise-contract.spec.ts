...
import incrementerAbiPre97 from '../../../api-contract/test/contracts<spec_version-97/Incrementer.json';
import incrementerAbiPost97 from '../../../api-contract/test/contracts>=spec_version-97/Incrementer.json';

const incrementerCodePre97 = fs.readFileSync(path.join(__dirname, '../../../api-contract/test/contracts<spec_version-97/incrementer-pruned.wasm')).toString('hex');
const incrementerCodePost97 = fs.readFileSync(path.join(__dirname, '../../../api-contract/test/contracts>=spec_version-97/incrementer-pruned.wasm')).toString('hex');
