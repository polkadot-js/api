...
import incrementerAbiPost97 from '../../../api-contract/test/contracts_97/Incrementer.json';
...
const incrementerCodePost97 = fs.readFileSync(path.join(__dirname, '../../../api-contract/test/contracts_97/incrementer-pruned.wasm')).toString('hex');
