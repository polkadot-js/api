...
import incrementerAbi_0_96 from '../../../../api-contract/test/contracts_0_96/Incrementer.json'; // eslint-disable-line
import incrementerAbi_97_ from '../../../../api-contract/test/contracts_97_/Incrementer.json'; // eslint-disable-line
const incrementerCode_0_96 = fs.readFileSync(path.join(__dirname, '../../../../api-contract/test/contracts_0_96/incrementer-pruned.wasm')).toString('hex'); // eslint-disable-line
const incrementerCode_97_ = fs.readFileSync(path.join(__dirname, '../../../../api-contract/test/contracts_97_/incrementer-pruned.wasm')).toString('hex'); // eslint-disable-line
...
describeE2E({
  ...
  beforeEach(async (done): Promise<void> => {
    ...
    creationFee = api.consts && api.consts.contracts
      ? 123456789123456
      : 12345;
  ...
  describe('incrementer', (): void => {
    ...
    it('allows putCode', (done): Promise<() => void> => {
      const incrementerCode = runtimeVersion.specVersion.toNumber() < 97
        ? incrementerCode_0_96 // eslint-disable-line
        : incrementerCode_97_; // eslint-disable-line
      return (
        txBase
    ...
    it('allows contract create', (done): Promise<() => void> => {
      ...
      return (
        txBase
          .create(creationFee, MAX_GAS, codeHash, abi.deploy(randomStart))
    ...
    it('allows contract call', (done): Promise<() => void> => {
      ...
      return (
        txBase
          .call(address, creationFee, MAX_GAS, abi.messages.inc(3))
