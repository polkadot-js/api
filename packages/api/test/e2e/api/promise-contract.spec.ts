...
import incrementerAbi_0_96 from '../../../../api-contract/test/contracts_0_96/Incrementer.json'; // Only for 1.0 support
import incrementerAbi_97_ from '../../../../api-contract/test/contracts_97_/Incrementer.json';
const incrementerCode_0_96 = fs.readFileSync(path.join(__dirname, '../../../../api-contract/test/contracts_0_96/incrementer-pruned.wasm')).toString('hex'); // Only for 1.0 support
