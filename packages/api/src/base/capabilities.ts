...
type ExtractedQ = [u32 | null, bool | null, bool | null, bool | null, Releases | null];
...
function mapCapabilities ({ accountIdLength }: Constants, [leasePeriodsPerSlot, slotRangeCount]: ExtractedC, [systemBlockNumber, systemRefcount32, systemRefcountDual, systemRefcountTriple, stakingVersion]: ExtractedQ, [keys]: ExtractedR): Partial<DetectedTypes> {
  ...
  } else if (systemBlockNumber && !systemBlockNumber.isEmpty) {
