...
module.exports = function createSubscribeMethod (provider: ProviderInterface$Subscribe, rpcName: string, { inputs, output }: InterfaceMethodDefinition): Method {
  return async (_params: Array<mixed>, cb: ProviderInterface$Subscribe$Callback): Promise<number> => {
    try {
