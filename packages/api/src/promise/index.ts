...
import {
  ...
  Derive, DeriveFunction, DeriveSection,
 ...
 * ```
 */
export default class ApiPromise extends ApiBase<DecoratedRpc, QueryableStorage, SubmittableExtrinsics, Derive> implements ApiPromiseInterface {
