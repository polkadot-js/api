...
declare module './types' {
  export interface QueryableStorageExact<ApiType> {
    system: {
      ...
      randomMaterial: StorageEntryExact<ApiType, () => Observable<[i8, Vec<Hash>] & Codec>> & QueryableStorageEntry<ApiType>;
      ...
      eventTopics: StorageEntryExact<ApiType, (key1: Null, key2: Hash | Uint8Array | string) => Observable<Vec<[BlockNumber, EventIndex] & Codec>>> & QueryableStorageEntry<ApiType>;
    };
    babe: {
      [index: string]: QueryableStorageEntry<ApiType>;
      epochIndex: StorageEntryExact<ApiType, () => Observable<u64>> & QueryableStorageEntry<ApiType>;
      authorities: StorageEntryExact<ApiType, () => Observable<Vec<[AuthorityId, BabeAuthorityWeight] & Codec>>> & QueryableStorageEntry<ApiType>;
      ...
      secondarySlots: StorageEntryExact<ApiType, () => Observable<[bool, bool] & Codec>> & QueryableStorageEntry<ApiType>;
    ...
    staking: {
      ...
      bondedEras: StorageEntryExact<ApiType, () => Observable<Vec<[EraIndex, SessionIndex] & Codec>>> & QueryableStorageEntry<ApiType>;
    ...
    session: {
      ...
      queuedKeys: StorageEntryExact<ApiType, () => Observable<Vec<[ValidatorId, Keys] & Codec>>> & QueryableStorageEntry<ApiType>;
      ...
      keyOwner: StorageEntryExact<ApiType, (key1: Bytes | Uint8Array | string, key2: [KeyTypeId, Bytes] & Codec) => Observable<ValidatorId>> & QueryableStorageEntry<ApiType>;
    };
    democracy: {
      [index: string]: QueryableStorageEntry<ApiType>;
      publicPropCount: StorageEntryExact<ApiType, () => Observable<PropIndex>> & QueryableStorageEntry<ApiType>;
      publicProps: StorageEntryExact<ApiType, () => Observable<Vec<[PropIndex, Proposal, AccountId] & Codec>>> & QueryableStorageEntry<ApiType>;
      depositOf: StorageEntryExact<ApiType, (arg: PropIndex | Uint8Array | number | string) => Observable<[BalanceOf, Vec<AccountId>] & Codec>> & QueryableStorageEntry<ApiType>;
      ...
      dispatchQueue: StorageEntryExact<ApiType, (arg: BlockNumber | Uint8Array | number | string) => Observable<Vec<Option<[Proposal, ReferendumIndex] & Codec>>>> & QueryableStorageEntry<ApiType>;
      ...
      voteOf: StorageEntryExact<ApiType, (arg: [ReferendumIndex, AccountId] & Codec) => Observable<Vote>> & QueryableStorageEntry<ApiType>;
      proxy: StorageEntryExact<ApiType, (arg: AccountId | Uint8Array | string) => Observable<AccountId>> & QueryableStorageEntry<ApiType>;
      delegations: StorageEntryExact<ApiType, (arg: AccountId | Uint8Array | string) => Observable<[AccountId, Conviction] & Codec>> & QueryableStorageEntry<ApiType>;
      lastTabledWasExternal: StorageEntryExact<ApiType, () => Observable<bool>> & QueryableStorageEntry<ApiType>;
      nextExternal: StorageEntryExact<ApiType, () => Observable<[Proposal, VoteThreshold] & Codec>> & QueryableStorageEntry<ApiType>;
      blacklist: StorageEntryExact<ApiType, (arg: Hash | Uint8Array | string) => Observable<[BlockNumber, Vec<AccountId>] & Codec>> & QueryableStorageEntry<ApiType>;
    ...
    elections: {
      ...
      members: StorageEntryExact<ApiType, () => Observable<Vec<[AccountId, BlockNumber] & Codec>>> & QueryableStorageEntry<ApiType>;
      voteCount: StorageEntryExact<ApiType, () => Observable<VoteIndex>> & QueryableStorageEntry<ApiType>;
      approvalsOf: StorageEntryExact<ApiType, (arg: [AccountId, SetIndex] & Codec) => Observable<Vec<ApprovalFlag>>> & QueryableStorageEntry<ApiType>;
      registerInfoOf: StorageEntryExact<ApiType, (arg: AccountId | Uint8Array | string) => Observable<[VoteIndex, u32] & Codec>> & QueryableStorageEntry<ApiType>;
      ...
      nextFinalize: StorageEntryExact<ApiType, () => Observable<[BlockNumber, u32, Vec<AccountId>] & Codec>> & QueryableStorageEntry<ApiType>;
      leaderboard: StorageEntryExact<ApiType, () => Observable<Vec<[BalanceOf, AccountId] & Codec>>> & QueryableStorageEntry<ApiType>;
      proxy: StorageEntryExact<ApiType, (arg: AccountId | Uint8Array | string) => Observable<AccountId>> & QueryableStorageEntry<ApiType>;
    };
    technicalMembership: {
      [index: string]: QueryableStorageEntry<ApiType>;
    ...
    grandpa: {
      [index: string]: QueryableStorageEntry<ApiType>;
      authorities: StorageEntryExact<ApiType, () => Observable<Vec<[AuthorityId, AuthorityWeight] & Codec>>> & QueryableStorageEntry<ApiType>;
      ...
      stalled: StorageEntryExact<ApiType, () => Observable<[BlockNumber, BlockNumber] & Codec>> & QueryableStorageEntry<ApiType>;
