...
declare module '@polkadot/api/types/events' {
  export interface AugmentedEvents<ApiType> {
    assets: {
       ...
       **/
      ApprovedTransfer: AugmentedEvent<ApiType, [u32, AccountId32, AccountId32, TypeAs<'Weight', u64>]>;
      /**
       ...
       **/
      Burned: AugmentedEvent<ApiType, [u32, AccountId32, TypeAs<'Weight', u64>]>;
      /**
       ...
       **/
      Issued: AugmentedEvent<ApiType, [u32, AccountId32, TypeAs<'Weight', u64>]>;
      /**
       ...
       **/
      Transferred: AugmentedEvent<ApiType, [u32, AccountId32, AccountId32, TypeAs<'Weight', u64>]>;
      /**
       * An `amount` was transferred in its entirety from `owner` to `destination` by
       * the approved `delegate`.
       * \[id, owner, delegate, destination\]
       **/
      TransferredApproved: AugmentedEvent<ApiType, [u32, AccountId32, AccountId32, AccountId32, TypeAs<'Weight', u64>]>;
      /**
       * Generic event
       **/
    ...
    bagsList: {
       ...
       **/
      Rebagged: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Weight', u64>, TypeAs<'Weight', u64>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    balances: {
       ...
       **/
      BalanceSet: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>, TypeAs<'Balance', u128>]>;
      /**
       * Some amount was deposited (e.g. for transaction fees). \[who, deposit\]
       **/
      Deposit: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * An account was removed whose balance was non-zero but below ExistentialDeposit,
       * resulting in an outright loss. \[account, balance\]
       **/
      DustLost: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * An account was created with some free balance. \[account, free_balance\]
       **/
      Endowed: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Some balance was reserved (moved from free to reserved). \[who, value\]
       **/
      Reserved: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Some balance was moved from the reserve of the first account to the second account.
       * Final argument indicates the destination balance type.
       * \[from, to, balance, destination_status\]
       **/
      ReserveRepatriated: AugmentedEvent<ApiType, [AccountId32, AccountId32, TypeAs<'Balance', u128>, FrameSupportTokensMiscBalanceStatus]>;
      /**
       * Transfer succeeded. \[from, to, value\]
       **/
      Transfer: AugmentedEvent<ApiType, [AccountId32, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Some balance was unreserved (moved from reserved to free). \[who, value\]
       **/
      Unreserved: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    bounties: {
       ...
       **/
      BountyClaimed: AugmentedEvent<ApiType, [u32, TypeAs<'Balance', u128>, AccountId32]>;
      /**
       ...
       **/
      BountyRejected: AugmentedEvent<ApiType, [u32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    democracy: {
       ...
       **/
      PreimageNoted: AugmentedEvent<ApiType, [H256, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * A registered preimage was removed and the deposit collected by the reaper.
       * \[proposal_hash, provider, deposit, reaper\]
       **/
      PreimageReaped: AugmentedEvent<ApiType, [H256, AccountId32, TypeAs<'Balance', u128>, AccountId32]>;
      /**
       * A proposal preimage was removed and used (the deposit was returned).
       * \[proposal_hash, provider, deposit\]
       **/
      PreimageUsed: AugmentedEvent<ApiType, [H256, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * A motion has been proposed by a public account. \[proposal_index, deposit\]
       **/
      Proposed: AugmentedEvent<ApiType, [u32, TypeAs<'Balance', u128>]>;
      /**
       ...
       * depositors\]
       **/
      Tabled: AugmentedEvent<ApiType, [u32, TypeAs<'Balance', u128>, Vec<AccountId32>]>;
      /**
    ...
    electionProviderMultiPhase: {
       ...
       **/
      Rewarded: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      Slashed: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
    ...
    elections: {
       ...
       **/
      CandidateSlashed: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      SeatHolderSlashed: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    gilt: {
       ...
       * \[ who, amount, duration \]
       **/
      BidPlaced: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>, u32]>;
      /**
       * A bid was successfully removed (before being accepted as a gilt).
       * \[ who, amount, duration \]
       **/
      BidRetracted: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>, u32]>;
      /**
       * A bid was accepted as a gilt. The balance may not be released until expiry.
       * \[ index, expiry, who, amount \]
       **/
      GiltIssued: AugmentedEvent<ApiType, [u32, u32, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * An expired gilt has been thawed.
       * \[ index, who, original_amount, additional_amount \]
       **/
      GiltThawed: AugmentedEvent<ApiType, [u32, AccountId32, TypeAs<'Balance', u128>, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    identity: {
       ...
       **/
      IdentityCleared: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * A name was removed and the given balance slashed. \[who, deposit\]
       **/
      IdentityKilled: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      SubIdentityAdded: AugmentedEvent<ApiType, [AccountId32, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * A sub-identity was removed from an identity and the deposit freed.
       * \[sub, main, deposit\]
       **/
      SubIdentityRemoved: AugmentedEvent<ApiType, [AccountId32, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * A sub-identity was cleared, and the given deposit repatriated from the
       * main identity account to the sub-identity account. \[sub, main, deposit\]
       **/
      SubIdentityRevoked: AugmentedEvent<ApiType, [AccountId32, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    lottery: {
       ...
       **/
      Winner: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    society: {
       ...
       **/
      Bid: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      Deposit: AugmentedEvent<ApiType, [TypeAs<'Balance', u128>]>;
      /**
       ...
       * vouching\]
       **/
      Vouch: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>, AccountId32]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    staking: {
       ...
       **/
      Bonded: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      EraPaid: AugmentedEvent<ApiType, [u32, TypeAs<'Balance', u128>, TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      Unbonded: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * An account has called `withdraw_unbonded` and removed unbonding chunks worth `Balance`
       * from the unlocking queue. \[stash, amount\]
       **/
      Withdrawn: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    tips: {
       ...
       **/
      TipClosed: AugmentedEvent<ApiType, [H256, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      TipSlashed: AugmentedEvent<ApiType, [H256, AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    treasury: {
       ...
       **/
      Awarded: AugmentedEvent<ApiType, [u32, TypeAs<'Balance', u128>, AccountId32]>;
      /**
       * Some of our funds have been burnt. \[burn\]
       **/
      Burnt: AugmentedEvent<ApiType, [TypeAs<'Balance', u128>]>;
      /**
       ...
       **/
      Rejected: AugmentedEvent<ApiType, [u32, TypeAs<'Balance', u128>]>;
      /**
       * Spending has finished; this is the amount that rolls over until next spend.
       * \[budget_remaining\]
       **/
      Rollover: AugmentedEvent<ApiType, [TypeAs<'Balance', u128>]>;
      /**
       * We have ended a spend period and will now allocate funds. \[budget_remaining\]
       **/
      Spending: AugmentedEvent<ApiType, [TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    vesting: {
       ...
       * \[account, unvested\]
       **/
      VestingUpdated: AugmentedEvent<ApiType, [AccountId32, TypeAs<'Balance', u128>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
