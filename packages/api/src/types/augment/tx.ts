...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    system: {
       ...
       **/
      fillBlock: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Make some on-chain remark.
       **/
      remark: AugmentedExtrinsic<(remark: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Set the number of pages in the WebAssembly environment's heap.
       **/
      setHeapPages: AugmentedExtrinsic<(pages: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Set the new runtime code.
       **/
      setCode: AugmentedExtrinsic<(code: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Set the new runtime code without doing any checks of the given `code`.
       **/
      setCodeWithoutChecks: AugmentedExtrinsic<(code: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Set the new changes trie configuration.
       **/
      setChangesTrieConfig: AugmentedExtrinsic<(changesTrieConfig: Option<ChangesTrieConfiguration> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Set some items of storage.
       **/
      setStorage: AugmentedExtrinsic<(items: Vec<KeyValue> | (KeyValue)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Kill some items from storage.
       **/
      killStorage: AugmentedExtrinsic<(keys: Vec<Key> | (Key | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Kill all storage items with a key that starts with the given prefix.
       **/
      killPrefix: AugmentedExtrinsic<(prefix: Key | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    utility: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Send a batch of dispatch calls.  This will execute until the first one fails and then stop.  May be called from any origin.  - `calls`: The calls to be dispatched from the same origin.  # <weight> - The sum of the weights of the `calls`. - One event. # </weight>  This will return `Ok` in all circumstances. To determine the success of the batch, an event is deposited. If a call failed and the batch was interrupted, then the `BatchInterrupted` event is deposited, along with the number of successful calls made and the error of the failed call. If all were successful, then the `BatchCompleted` event is deposited.
       **/
      batch: AugmentedExtrinsic<(calls: Vec<Call> | (Call | object | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Send a call through an indexed pseudonym of the sender.  The dispatch origin for this call must be _Signed_.  # <weight> - The weight of the `call`. # </weight>
       **/
      asSub: AugmentedExtrinsic<(index: u16 | AnyNumber | Uint8Array, call: Call | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      asMulti: AugmentedExtrinsic<(threshold: u16 | AnyNumber | Uint8Array, otherSignatories: Vec<AccountId> | (AccountId | string | Uint8Array)[], maybeTimepoint: Option<Timepoint> | null | object | string | Uint8Array, call: Call | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      approveAsMulti: AugmentedExtrinsic<(threshold: u16 | AnyNumber | Uint8Array, otherSignatories: Vec<AccountId> | (AccountId | string | Uint8Array)[], maybeTimepoint: Option<Timepoint> | null | object | string | Uint8Array, callHash: Raw | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      cancelAsMulti: AugmentedExtrinsic<(threshold: u16 | AnyNumber | Uint8Array, otherSignatories: Vec<AccountId> | (AccountId | string | Uint8Array)[], timepoint: Timepoint | object | string | Uint8Array, callHash: Raw | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    timestamp: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      set: AugmentedExtrinsic<(now: Compact<Moment> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    authorship: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      setUncles: AugmentedExtrinsic<(newUncles: Vec<Header> | (Header | object | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
    };
    balances: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      transfer: AugmentedExtrinsic<(dest: Address | string | AccountId | AccountIndex | Uint8Array, value: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setBalance: AugmentedExtrinsic<(who: Address | string | AccountId | AccountIndex | Uint8Array, newFree: Compact<Balance> | AnyNumber | Uint8Array, newReserved: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Exactly as `transfer`, except the origin must be root and the source account may be specified.
       **/
      forceTransfer: AugmentedExtrinsic<(source: Address | string | AccountId | AccountIndex | Uint8Array, dest: Address | string | AccountId | AccountIndex | Uint8Array, value: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Same as the [`transfer`] call, but with a check that the transfer will not kill the origin account.  99% of the time you want [`transfer`] instead.  [`transfer`]: struct.Module.html#method.transfer
       **/
      transferKeepAlive: AugmentedExtrinsic<(dest: Address | string | AccountId | AccountIndex | Uint8Array, value: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    staking: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      bond: AugmentedExtrinsic<(controller: Address | string | AccountId | AccountIndex | Uint8Array, value: Compact<BalanceOf> | AnyNumber | Uint8Array, payee: RewardDestination) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      bondExtra: AugmentedExtrinsic<(maxAdditional: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      unbond: AugmentedExtrinsic<(value: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      withdrawUnbonded: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      validate: AugmentedExtrinsic<(prefs: ValidatorPrefs | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      nominate: AugmentedExtrinsic<(targets: Vec<Address> | (Address | string | AccountId | AccountIndex | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      chill: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setPayee: AugmentedExtrinsic<(payee: RewardDestination) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setController: AugmentedExtrinsic<(controller: Address | string | AccountId | AccountIndex | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * The ideal number of validators.
       **/
      setValidatorCount: AugmentedExtrinsic<(updated: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Force there to be no new eras indefinitely.  # <weight> - No arguments. # </weight>
       **/
      forceNoEras: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      forceNewEra: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Set the validators who cannot be slashed (if any).
       **/
      setInvulnerables: AugmentedExtrinsic<(validators: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Force a current staker to become completely unstaked, immediately.
       **/
      forceUnstake: AugmentedExtrinsic<(stash: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Force there to be a new era at the end of sessions indefinitely.  # <weight> - One storage write # </weight>
       **/
      forceNewEraAlways: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      cancelDeferredSlash: AugmentedExtrinsic<(era: EraIndex | AnyNumber | Uint8Array, slashIndices: Vec<u32> | (u32 | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Rebond a portion of the stash scheduled to be unlocked.  # <weight> - Time complexity: O(1). Bounded by `MAX_UNLOCKING_CHUNKS`. - Storage changes: Can't increase storage, only decrease it. # </weight>
       **/
      rebond: AugmentedExtrinsic<(value: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    session: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Sets the session key(s) of the function caller to `keys`. Allows an account to set its session key prior to becoming a validator. This doesn't take effect until the next session.  The dispatch origin of this function must be signed.  # <weight> - O(log n) in number of accounts. - One extra DB entry. # </weight>
       **/
      setKeys: AugmentedExtrinsic<(keys: Keys, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    democracy: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Propose a sensitive action to be taken.  # <weight> - O(1). - Two DB changes, one DB entry. # </weight>
       **/
      propose: AugmentedExtrinsic<(proposalHash: Hash | string | Uint8Array, value: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Propose a sensitive action to be taken.  # <weight> - O(1). - One DB entry. # </weight>
       **/
      second: AugmentedExtrinsic<(proposal: Compact<PropIndex> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Vote in a referendum. If `vote.is_aye()`, the vote is to enact the proposal; otherwise it is a vote to keep the status quo.  # <weight> - O(1). - One DB change, one DB entry. # </weight>
       **/
      vote: AugmentedExtrinsic<(refIndex: Compact<ReferendumIndex> | AnyNumber | Uint8Array, vote: Vote | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Vote in a referendum on behalf of a stash. If `vote.is_aye()`, the vote is to enact the proposal; otherwise it is a vote to keep the status quo.  # <weight> - O(1). - One DB change, one DB entry. # </weight>
       **/
      proxyVote: AugmentedExtrinsic<(refIndex: Compact<ReferendumIndex> | AnyNumber | Uint8Array, vote: Vote | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Schedule an emergency cancellation of a referendum. Cannot happen twice to the same referendum.
       **/
      emergencyCancel: AugmentedExtrinsic<(refIndex: ReferendumIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Schedule a referendum to be tabled once it is legal to schedule an external referendum.
       **/
      externalPropose: AugmentedExtrinsic<(proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Schedule a majority-carries referendum to be tabled next once it is legal to schedule an external referendum.  Unlike `external_propose`, blacklisting has no effect on this and it may replace a pre-scheduled `external_propose` call.
       **/
      externalProposeMajority: AugmentedExtrinsic<(proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Schedule a negative-turnout-bias referendum to be tabled next once it is legal to schedule an external referendum.  Unlike `external_propose`, blacklisting has no effect on this and it may replace a pre-scheduled `external_propose` call.
       **/
      externalProposeDefault: AugmentedExtrinsic<(proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      fastTrack: AugmentedExtrinsic<(proposalHash: Hash | string | Uint8Array, votingPeriod: BlockNumber | AnyNumber | Uint8Array, delay: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Veto and blacklist the external proposal hash.
       **/
      vetoExternal: AugmentedExtrinsic<(proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Remove a referendum.
       **/
      cancelReferendum: AugmentedExtrinsic<(refIndex: Compact<ReferendumIndex> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Cancel a proposal queued for enactment.
       **/
      cancelQueued: AugmentedExtrinsic<(which: ReferendumIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Specify a proxy. Called by the stash.  # <weight> - One extra DB entry. # </weight>
       **/
      setProxy: AugmentedExtrinsic<(proxy: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Clear the proxy. Called by the proxy.  # <weight> - One DB clear. # </weight>
       **/
      resignProxy: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Clear the proxy. Called by the stash.  # <weight> - One DB clear. # </weight>
       **/
      removeProxy: AugmentedExtrinsic<(proxy: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Delegate vote.  # <weight> - One extra DB entry. # </weight>
       **/
      delegate: AugmentedExtrinsic<(to: AccountId | string | Uint8Array, conviction: Conviction) => SubmittableExtrinsic<ApiType>>;
      /**
       * Undelegate vote.  # <weight> - O(1). # </weight>
       **/
      undelegate: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Veto and blacklist the proposal hash. Must be from Root origin.
       **/
      clearPublicProposals: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      notePreimage: AugmentedExtrinsic<(encodedProposal: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Register the preimage for an upcoming proposal. This requires the proposal to be in the dispatch queue. No deposit is needed.
       **/
      noteImminentPreimage: AugmentedExtrinsic<(encodedProposal: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Remove an expired proposal preimage and collect the deposit.  This will only work after `VotingPeriod` blocks from the time that the preimage was noted, if it's the same account doing it. If it's a different account, then it'll only work an additional `EnactmentPeriod` later.
       **/
      reapPreimage: AugmentedExtrinsic<(proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    council: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Set the collective's membership manually to `new_members`. Be nice to the chain and provide it pre-sorted.  Requires root origin.
       **/
      setMembers: AugmentedExtrinsic<(newMembers: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Dispatch a proposal from a member using the `Member` origin.  Origin must be a member of the collective.
       **/
      execute: AugmentedExtrinsic<(proposal: Proposal | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * # <weight> - Bounded storage reads and writes. - Argument `threshold` has bearing on weight. # </weight>
       **/
      propose: AugmentedExtrinsic<(threshold: Compact<MemberCount> | AnyNumber | Uint8Array, proposal: Proposal | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * # <weight> - Bounded storage read and writes. - Will be slightly heavier if the proposal is approved / disapproved after the vote. # </weight>
       **/
      vote: AugmentedExtrinsic<(proposal: Hash | string | Uint8Array, index: Compact<ProposalIndex> | AnyNumber | Uint8Array, approve: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    technicalCommittee: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    elections: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Vote for a set of candidates for the upcoming round of election.  The `votes` should: - not be empty. - be less than the number of candidates.  Upon voting, `value` units of `who`'s balance is locked and a bond amount is reserved. It is the responsibility of the caller to not place all of their balance into the lock and keep some for further transactions.  # <weight> #### State Reads: O(1) Writes: O(V) given `V` votes. V is bounded by 16. # </weight>
       **/
      vote: AugmentedExtrinsic<(votes: Vec<AccountId> | (AccountId | string | Uint8Array)[], value: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Remove `origin` as a voter. This removes the lock and returns the bond.  # <weight> #### State Reads: O(1) Writes: O(1) # </weight>
       **/
      removeVoter: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Report `target` for being an defunct voter. In case of a valid report, the reporter is rewarded by the bond amount of `target`. Otherwise, the reporter itself is removed and their bond is slashed.  A defunct voter is defined to be: - a voter whose current submitted votes are all invalid. i.e. all of them are no longer a candidate nor an active member.  # <weight> #### State Reads: O(NLogM) given M current candidates and N votes for `target`. Writes: O(1) # </weight>
       **/
      reportDefunctVoter: AugmentedExtrinsic<(target: Address | string | AccountId | AccountIndex | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Submit oneself for candidacy.  A candidate will either: - Lose at the end of the term and forfeit their deposit. - Win and become a member. Members will eventually get their stash back. - Become a runner-up. Runners-ups are reserved members in case one gets forcefully removed.  # <weight> #### State Reads: O(LogN) Given N candidates. Writes: O(1) # </weight>
       **/
      submitCandidacy: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Renounce one's intention to be a candidate for the next election round. 3 potential outcomes exist: - `origin` is a candidate and not elected in any set. In this case, the bond is unreserved, returned and origin is removed as a candidate. - `origin` is a current runner up. In this case, the bond is unreserved, returned and origin is removed as a runner. - `origin` is a current member. In this case, the bond is unreserved and origin is removed as a member, consequently not being a candidate for the next round anymore. Similar to [`remove_voter`], if replacement runners exists, they are immediately used.
       **/
      renounceCandidacy: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Remove a particular member from the set. This is effective immediately and the bond of the outgoing member is slashed.  If a runner-up is available, then the best runner-up will be removed and replaces the outgoing member. Otherwise, a new phragmen round is started.  Note that this does not affect the designated block number of the next election.  # <weight> #### State Reads: O(do_phragmen) Writes: O(do_phragmen) # </weight>
       **/
      removeMember: AugmentedExtrinsic<(who: Address | string | AccountId | AccountIndex | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    technicalMembership: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      addMember: AugmentedExtrinsic<(who: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Remove a member `who` from the set.  May only be called from `RemoveOrigin` or root.
       **/
      removeMember: AugmentedExtrinsic<(who: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Swap out one member `remove` for another `add`.  May only be called from `SwapOrigin` or root.
       **/
      swapMember: AugmentedExtrinsic<(remove: AccountId | string | Uint8Array, add: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Change the membership to a new set, disregarding the existing membership. Be nice and pass `members` pre-sorted.  May only be called from `ResetOrigin` or root.
       **/
      resetMembers: AugmentedExtrinsic<(members: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Swap out the sending member for some other key `new`.  May only be called from `Signed` origin of a current member.
       **/
      changeKey: AugmentedExtrinsic<(updated: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    finalityTracker: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      finalHint: AugmentedExtrinsic<(hint: Compact<BlockNumber> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    grandpa: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      reportMisbehavior: AugmentedExtrinsic<(report: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    treasury: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      proposeSpend: AugmentedExtrinsic<(value: Compact<BalanceOf> | AnyNumber | Uint8Array, beneficiary: Address | string | AccountId | AccountIndex | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Reject a proposed spend. The original deposit will be slashed.  # <weight> - O(1). - Limited storage reads. - One DB clear. # </weight>
       **/
      rejectProposal: AugmentedExtrinsic<(proposalId: Compact<ProposalIndex> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      approveProposal: AugmentedExtrinsic<(proposalId: Compact<ProposalIndex> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      reportAwesome: AugmentedExtrinsic<(reason: Bytes | string | Uint8Array, who: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      retractTip: AugmentedExtrinsic<(hash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      tipNew: AugmentedExtrinsic<(reason: Bytes | string | Uint8Array, who: AccountId | string | Uint8Array, tipValue: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      tip: AugmentedExtrinsic<(hash: Hash | string | Uint8Array, tipValue: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      closeTip: AugmentedExtrinsic<(hash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    contracts: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      updateSchedule: AugmentedExtrinsic<(schedule: Schedule | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      putCode: AugmentedExtrinsic<(gasLimit: Compact<Gas> | AnyNumber | Uint8Array, code: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      call: AugmentedExtrinsic<(dest: Address | string | AccountId | AccountIndex | Uint8Array, value: Compact<BalanceOf> | AnyNumber | Uint8Array, gasLimit: Compact<Gas> | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      instantiate: AugmentedExtrinsic<(endowment: Compact<BalanceOf> | AnyNumber | Uint8Array, gasLimit: Compact<Gas> | AnyNumber | Uint8Array, codeHash: CodeHash | string | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      claimSurcharge: AugmentedExtrinsic<(dest: AccountId | string | Uint8Array, auxSender: Option<AccountId> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    sudo: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      sudo: AugmentedExtrinsic<(proposal: Proposal | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setKey: AugmentedExtrinsic<(updated: Address | string | AccountId | AccountIndex | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      sudoAs: AugmentedExtrinsic<(who: Address | string | AccountId | AccountIndex | Uint8Array, proposal: Proposal | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    imOnline: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      heartbeat: AugmentedExtrinsic<(heartbeat: Heartbeat | object | string | Uint8Array, signature: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    identity: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Add a registrar to the system.  The dispatch origin for this call must be `RegistrarOrigin` or `Root`.  - `account`: the account of the registrar.  Emits `RegistrarAdded` if successful.  # <weight> - `O(R)` where `R` registrar-count (governance-bounded). - One storage mutation (codec `O(R)`). - One event. # </weight>
       **/
      addRegistrar: AugmentedExtrinsic<(account: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setIdentity: AugmentedExtrinsic<(info: IdentityInfo | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setSubs: AugmentedExtrinsic<(subs: Vec<ITuple<[AccountId, Data]>> | ([AccountId | string | Uint8Array, Data])[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      clearIdentity: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      requestJudgement: AugmentedExtrinsic<(regIndex: Compact<RegistrarIndex> | AnyNumber | Uint8Array, maxFee: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      cancelRequest: AugmentedExtrinsic<(regIndex: RegistrarIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setFee: AugmentedExtrinsic<(index: Compact<RegistrarIndex> | AnyNumber | Uint8Array, fee: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Change the account associated with a registrar.  The dispatch origin for this call must be _Signed_ and the sender must be the account of the registrar whose index is `index`.  - `index`: the index of the registrar whose fee is to be set. - `new`: the new account ID.  # <weight> - `O(R)`. - One storage mutation `O(R)`. # </weight>
       **/
      setAccountId: AugmentedExtrinsic<(index: Compact<RegistrarIndex> | AnyNumber | Uint8Array, updated: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setFields: AugmentedExtrinsic<(index: Compact<RegistrarIndex> | AnyNumber | Uint8Array, fields: IdentityFields) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      provideJudgement: AugmentedExtrinsic<(regIndex: Compact<RegistrarIndex> | AnyNumber | Uint8Array, target: Address | string | AccountId | AccountIndex | Uint8Array, judgement: IdentityJudgement) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      killIdentity: AugmentedExtrinsic<(target: Address | string | AccountId | AccountIndex | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    society: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      vouch: AugmentedExtrinsic<(who: AccountId | string | Uint8Array, value: BalanceOf | AnyNumber | Uint8Array, tip: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * As a vouching member, unvouch a bid. This only works while vouched user is only a bidder (and not a candidate).  The dispatch origin for this call must be _Signed_ and a vouching member.  Parameters: - `pos`: Position in the `Bids` vector of the bid who should be unvouched.  # <weight> Key: B (len of bids) - One storage read O(1) to check the signer is a vouching member. - One storage mutate to retrieve and update the bids. O(B) - One vouching storage removal. O(1) - One event.  Total Complexity: O(B) # </weight>
       **/
      unvouch: AugmentedExtrinsic<(pos: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      vote: AugmentedExtrinsic<(candidate: Address | string | AccountId | AccountIndex | Uint8Array, approve: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * As a member, vote on the defender.  The dispatch origin for this call must be _Signed_ and a member.  Parameters: - `approve`: A boolean which says if the candidate should be approved (`true`) or rejected (`false`).  # <weight> - Key: M (len of members) - One storage read O(M) and O(log M) search to check user is a member. - One storage write to add vote to votes. O(1) - One event.  Total Complexity: O(M + logM) # </weight>
       **/
      defenderVote: AugmentedExtrinsic<(approve: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      payout: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      found: AugmentedExtrinsic<(founder: AccountId | string | Uint8Array, maxMembers: u32 | AnyNumber | Uint8Array, rules: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Anull the founding of the society.  The dispatch origin for this call must be Signed, and the signing account must be both the `Founder` and the `Head`. This implies that it may only be done when there is one member.  # <weight> - Two storage reads O(1). - Four storage removals O(1). - One event.  Total Complexity: O(1) # </weight>
       **/
      unfound: AugmentedExtrinsic<() => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setMaxMembers: AugmentedExtrinsic<(max: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    recovery: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      asRecovered: AugmentedExtrinsic<(account: AccountId | string | Uint8Array, call: Call | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      setRecovered: AugmentedExtrinsic<(lost: AccountId | string | Uint8Array, rescuer: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      createRecovery: AugmentedExtrinsic<(friends: Vec<AccountId> | (AccountId | string | Uint8Array)[], threshold: u16 | AnyNumber | Uint8Array, delayPeriod: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      initiateRecovery: AugmentedExtrinsic<(account: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      vouchRecovery: AugmentedExtrinsic<(lost: AccountId | string | Uint8Array, rescuer: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      claimRecovery: AugmentedExtrinsic<(account: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
