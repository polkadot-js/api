...
export default {
  ...
  PalletRcMigratorMigrationStage: {
    _enum: {
      ...
      StakingMigrationOngoing: {
        nextKey: 'Option<PalletRcMigratorStakingStakingStage>',
      },
  ...
  /**
   * Lookup547: pallet_rc_migrator::staking::staking::StakingStage<sp_core::crypto::AccountId32>
   **/
  PalletRcMigratorStakingStakingStage: {
    _enum: {
      Values: 'Null',
      Invulnerables: 'Null',
  ...
  /**
   * Lookup565: staging_kusama_runtime::RuntimeParametersKey
   **/
  ...
  /**
   * Lookup566: staging_kusama_runtime::dynamic_params::inflation::ParametersKey
   **/
  ...
  /**
   * Lookup567: staging_kusama_runtime::dynamic_params::treasury::ParametersKey
   **/
  StagingKusamaRuntimeDynamicParamsTreasuryParametersKey: {
    _enum: ['BurnPortion', 'BurnDestination']
  },
  /**
   * Lookup569: staging_kusama_runtime::RuntimeParametersValue
   **/
  ...
  /**
   * Lookup570: staging_kusama_runtime::dynamic_params::inflation::ParametersValue
   **/
  ...
  /**
   * Lookup571: staging_kusama_runtime::dynamic_params::treasury::ParametersValue
   **/
  ...
  /**
   * Lookup578: pallet_recovery::DepositKind<staging_kusama_runtime::Runtime>
   **/
  ...
  /**
   * Lookup579: staging_kusama_runtime::Runtime
   **/
  StagingKusamaRuntimeRuntime: 'Null',
  /**
   * Lookup597: pallet_staking_async_ah_client::pallet::Event<T>
   **/
  ...
  /**
   * Lookup598: pallet_staking_async_ah_client::pallet::UnexpectedKind
   **/
  PalletStakingAsyncAhClientUnexpectedKind: {
    _enum: ['ReceivedValidatorSetWhilePassive', 'UnexpectedModeTransition']
  },
  /**
   * Lookup616: staging_xcm::v5::traits::InstructionError
   **/
  ...
  /**
   * Lookup621: pallet_rc_migrator::pallet::Event<T>
   **/
  ...
  /**
   * Lookup667: staging_kusama_runtime::RuntimeHoldReason
   **/
  ...
  /**
   * Lookup669: pallet_session::pallet::HoldReason
   **/
  PalletSessionHoldReason: {
    _enum: ['Keys']
  },
  /**
   * Lookup676: staging_kusama_runtime::RuntimeFreezeReason
   **/
  ...
  /**
   * Lookup823: frame_election_provider_support::BoundedSupports<sp_core::crypto::AccountId32, BOuter, BInner>
   **/
  FrameElectionProviderSupportBoundedSupports: 'Vec<(AccountId32,FrameElectionProviderSupportBoundedSupport)>',
  /**
   * Lookup826: frame_election_provider_support::BoundedSupport<sp_core::crypto::AccountId32, Bound>
   **/
  ...
  /**
   * Lookup869: pallet_staking_async_ah_client::BufferedOffence<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup874: pallet_staking_async_ah_client::pallet::Error<T>
   **/
  PalletStakingAsyncAhClientError: {
    _enum: ['Blocked']
  },
  /**
   * Lookup919: polkadot_runtime_parachains::paras::AuthorizedCodeHashAndExpiry<T>
   **/
  ...
  /**
   * Lookup944: polkadot_primitives::vstaging::PendingSlashes
   **/
  ...
  /**
   * Lookup1012: pallet_xcm::errors::ExecutionError
   **/
  ...
  /**
   * Lookup1025: pallet_rc_migrator::accounts::AccountState<Balance>
   **/
  ...
  /**
   * Lookup1026: pallet_rc_migrator::accounts::MigratedBalances<Balance>
   **/
  ...
  /**
   * Lookup1027: pallet_rc_migrator::pallet::Error<T>
   **/
  ...
  /**
   * Lookup1157: staging_kusama_runtime::RuntimeError
   **/
