...
import type { BTreeMap, Compact, Enum, Null, Option, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletRcMigratorCall extends Enum {
    ...
    readonly type: 'ForceSetStage' | 'ScheduleMigration' | 'StartDataMigration' | 'ReceiveQueryResponse' | 'ResendXcm' | 'SetUnprocessedMsgBuffer' | 'SetAhUmpQueuePriority' | 'SetManager' | 'SendXcmMessage' | 'PreserveAccounts' | 'SetCanceller' | 'PauseMigration' | 'CancelMigration';
  }
  ...
  /** @name PalletRcMigratorStakingStakingStage (547) */
  ...
  /** @name StagingKusamaRuntimeRuntimeParametersKey (565) */
  ...
  /** @name StagingKusamaRuntimeDynamicParamsInflationParametersKey (566) */
  ...
  /** @name StagingKusamaRuntimeDynamicParamsTreasuryParametersKey (567) */
  ...
  /** @name StagingKusamaRuntimeRuntimeParametersValue (569) */
  ...
  /** @name StagingKusamaRuntimeDynamicParamsInflationParametersValue (570) */
  ...
  /** @name StagingKusamaRuntimeDynamicParamsTreasuryParametersValue (571) */
  ...
  /** @name PalletRecoveryDepositKind (578) */
  ...
  /** @name StagingKusamaRuntimeRuntime (579) */
  type StagingKusamaRuntimeRuntime = Null;

  /** @name PalletStakingAsyncAhClientEvent (597) */
  ...
  /** @name PalletStakingAsyncAhClientUnexpectedKind (598) */
  interface PalletStakingAsyncAhClientUnexpectedKind extends Enum {
    ...
    readonly type: 'ReceivedValidatorSetWhilePassive' | 'UnexpectedModeTransition';
  }

  /** @name StagingXcmV5TraitsInstructionError (616) */
  interface StagingXcmV5TraitsInstructionError extends Struct {
    readonly index: u8;
    readonly error: XcmV5TraitsError;
  }

  /** @name PalletRcMigratorEvent (621) */
  ...
  /** @name PalletSessionHoldReason (669) */
  interface PalletSessionHoldReason extends Enum {
    readonly isKeys: boolean;
    readonly type: 'Keys';
  }

  /** @name StagingKusamaRuntimeRuntimeFreezeReason (676) */
  ...
  /** @name FrameElectionProviderSupportBoundedSupports (823) */
  ...
  /** @name FrameElectionProviderSupportBoundedSupport (826) */
  interface FrameElectionProviderSupportBoundedSupport extends Struct {
    readonly total: u128;
    readonly voters: Vec<ITuple<[AccountId32, u128]>>;
  }

  /** @name PalletStakingAsyncAhClientBufferedOffence (869) */
  interface PalletStakingAsyncAhClientBufferedOffence extends Struct {
    readonly reporter: Option<AccountId32>;
    readonly slashFraction: Perbill;
  }

  /** @name PalletStakingAsyncAhClientError (874) */
  interface PalletStakingAsyncAhClientError extends Enum {
    readonly isBlocked: boolean;
    readonly type: 'Blocked';
  }

  /** @name PolkadotRuntimeParachainsParasAuthorizedCodeHashAndExpiry (919) */
  interface PolkadotRuntimeParachainsParasAuthorizedCodeHashAndExpiry extends Struct {
    readonly codeHash: H256;
    readonly expireAt: u32;
  }

  /** @name PolkadotPrimitivesVstagingPendingSlashes (944) */
  ...
  /** @name PalletXcmErrorsExecutionError (1012) */
  ...
  /** @name PalletRcMigratorAccountsAccountState (1025) */
  ...
  /** @name PalletRcMigratorAccountsMigratedBalances (1026) */
  interface PalletRcMigratorAccountsMigratedBalances extends Struct {
    readonly kept: u128;
    readonly migrated: u128;
  }

  /** @name PalletRcMigratorError (1027) */
  ...
  /** @name StagingKusamaRuntimeRuntimeError (1157) */
