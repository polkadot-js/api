...
declare module '@polkadot/types/lookup' {
  ...
  /** @name KusamaRuntimeSessionKeys (247) */
  ...
  /** @name KusamaRuntimeOriginCaller (320) */
  ...
  /** @name KusamaRuntimeNposCompactSolution24 (385) */
  ...
  /** @name PolkadotRuntimeParachainsDisputesPalletCall (505) */
