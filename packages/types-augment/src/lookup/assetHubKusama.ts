...
export default {
  ...
  /**
   * Lookup452: pallet_election_provider_multi_block::pallet::Call<T>
   **/
  ...
  /**
   * Lookup453: pallet_election_provider_multi_block::AdminOperation<T>
   **/
  ...
  /**
   * Lookup462: pallet_election_provider_multi_block::verifier::impls::pallet::Call<T>
   **/
  PalletElectionProviderMultiBlockVerifierImplsPalletCall: 'Null',
  /**
   * Lookup463: pallet_election_provider_multi_block::unsigned::pallet::Call<T>
   **/
  ...
  /**
   * Lookup464: pallet_election_provider_multi_block::types::PagedRawSolution<T>
   **/
  ...
  /**
   * Lookup541: pallet_election_provider_multi_block::signed::pallet::Call<T>
   **/
  ...
  /**
   * Lookup543: pallet_staking_async::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup549: pallet_staking_async::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup550: pallet_staking_async::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Percent>
   **/
  ...
  /**
   * Lookup551: pallet_staking_async::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup555: pallet_staking_async::ledger::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup569: pallet_ah_ops::pallet::Call<T>
   **/
  PalletAhOpsCall: {
    _enum: {
  ...
  /**
   * Lookup570: pallet_ah_migrator::pallet::Call<T>
   **/
  ...
  /**
   * Lookup572: pallet_rc_migrator::accounts::Account<sp_core::crypto::AccountId32, Balance, pallet_rc_migrator::types::PortableHoldReason, pallet_rc_migrator::types::PortableFreezeReason>
   **/
  ...
  /**
   * Lookup573: pallet_rc_migrator::types::PortableHoldReason
   **/
  ...
  /**
   * Lookup580: pallet_rc_migrator::types::PortableFreezeReason
   **/
  ...
  /**
   * Lookup583: frame_support::traits::tokens::misc::IdAmount<pallet_rc_migrator::types::PortableHoldReason, Balance>
   **/
  ...
  /**
   * Lookup586: frame_support::traits::tokens::misc::IdAmount<pallet_rc_migrator::types::PortableFreezeReason, Balance>
   **/
  ...
  /**
   * Lookup593: pallet_rc_migrator::multisig::RcMultisig<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup595: pallet_rc_migrator::proxy::RcProxy<sp_core::crypto::AccountId32, Balance, kusama_runtime_constants::proxy::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup600: pallet_rc_migrator::proxy::RcProxyAnnouncement<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup602: pallet_rc_migrator::preimage::chunks::RcPreimageChunk
   **/
  ...
  /**
   * Lookup605: pallet_rc_migrator::preimage::request_status::PortableRequestStatus
   **/
  ...
  /**
   * Lookup606: pallet_rc_migrator::preimage::request_status::PortableRequestStatusInner
   **/
  ...
  /**
   * Lookup611: pallet_rc_migrator::preimage::legacy_request_status::RcPreimageLegacyStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup613: pallet_rc_migrator::staking::nom_pools::RcNomPoolsMessage<T>
   **/
  ...
  /**
   * Lookup614: pallet_rc_migrator::staking::nom_pools::NomPoolsStorageValues<Balance>
   **/
  ...
  /**
   * Lookup627: pallet_rc_migrator::staking::nom_pools_alias::RewardPool<T>
   **/
  ...
  /**
   * Lookup629: pallet_rc_migrator::staking::nom_pools_alias::SubPools<T>
   **/
  ...
  /**
   * Lookup630: pallet_rc_migrator::staking::nom_pools_alias::UnbondPool<T>
   **/
  ...
  /**
   * Lookup638: pallet_rc_migrator::vesting::RcVestingSchedule<T>
   **/
  ...
  /**
   * Lookup642: pallet_rc_migrator::referenda::ReferendaMessage<Track>
   **/
  ...
  /**
   * Lookup652: pallet_referenda::types::ReferendumStatus<TrackId, asset_hub_kusama_runtime::ah_migration::RcPalletsOrigin, Moment, frame_support::traits::preimages::Bounded<asset_hub_kusama_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup660: pallet_rc_migrator::claims::RcClaimsMessage<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup665: pallet_rc_migrator::staking::bags_list::PortableBagsListMessage
   **/
  ...
  /**
   * Lookup666: pallet_rc_migrator::staking::bags_list::PortableNode
   **/
  ...
  /**
   * Lookup667: pallet_rc_migrator::staking::bags_list::PortableBag
   **/
  ...
  /**
   * Lookup669: pallet_rc_migrator::scheduler::RcSchedulerMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup674: pallet_rc_migrator::indices::RcIndicesIndex<AccountIndex, sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup676: pallet_rc_migrator::conviction_voting::RcConvictionVotingMessage<sp_core::crypto::AccountId32, Class, pallet_conviction_voting::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, PollIndex, MaxVotes>, Balance>
   **/
  ...
  /**
   * Lookup688: pallet_rc_migrator::bounties::RcBountiesMessage<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup691: pallet_rc_migrator::bounties::alias::Bounty<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup696: pallet_rc_migrator::crowdloan::RcCrowdloanMessage<BlockNumber, sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup700: pallet_rc_migrator::treasury::PortableTreasuryMessage
   **/
  ...
  /**
   * Lookup703: pallet_rc_migrator::treasury::PortableSpendStatus
   **/
  ...
  /**
   * Lookup704: pallet_rc_migrator::treasury::PortablePaymentState
   **/
  ...
  /**
   * Lookup706: pallet_rc_migrator::scheduler::SchedulerAgendaMessage<B, pallet_rc_migrator::scheduler::alias::Scheduled<frame_support::traits::preimages::Bounded<asset_hub_kusama_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, BlockNumber, asset_hub_kusama_runtime::ah_migration::RcPalletsOrigin>>
   **/
  ...
  /**
   * Lookup707: pallet_rc_migrator::scheduler::alias::Scheduled<frame_support::traits::preimages::Bounded<asset_hub_kusama_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, BlockNumber, asset_hub_kusama_runtime::ah_migration::RcPalletsOrigin>
   **/
  ...
  /**
   * Lookup713: pallet_rc_migrator::child_bounties::PortableChildBountiesMessage
   **/
  ...
  /**
   * Lookup714: pallet_rc_migrator::child_bounties::PortableChildBounty
   **/
  ...
  /**
   * Lookup718: pallet_rc_migrator::staking::message::PortableStakingMessage
   **/
  ...
  /**
   * Lookup719: pallet_rc_migrator::staking::message::StakingValues<Balance>
   **/
  ...
  /**
   * Lookup721: pallet_rc_migrator::staking::message::PortableActiveEraInfo
   **/
  ...
  /**
   * Lookup723: pallet_rc_migrator::staking::message::PortableForcing
   **/
  PalletRcMigratorStakingMessagePortableForcing: {
    _enum: ['NotForcing', 'ForceNew', 'ForceNone', 'ForceAlways']
  },
  /**
   * Lookup725: pallet_rc_migrator::staking::message::PortableStakingLedger
   **/
  ...
  /**
   * Lookup727: pallet_rc_migrator::staking::message::PortableUnlockChunk
   **/
  ...
  /**
   * Lookup729: pallet_rc_migrator::staking::message::PortableRewardDestination
   **/
  ...
  /**
   * Lookup730: pallet_rc_migrator::staking::message::PortableValidatorPrefs
   **/
  ...
  /**
   * Lookup731: pallet_rc_migrator::staking::message::PortableNominations
   **/
  ...
  /**
   * Lookup733: pallet_rc_migrator::staking::message::PortablePagedExposureMetadata
   **/
  ...
  /**
   * Lookup734: pallet_rc_migrator::staking::message::PortableExposurePage
   **/
  ...
  /**
   * Lookup736: pallet_rc_migrator::staking::message::PortableIndividualExposure
   **/
  ...
  /**
   * Lookup738: pallet_rc_migrator::staking::message::PortableEraRewardPoints
   **/
  ...
  /**
   * Lookup740: pallet_rc_migrator::staking::message::PortableUnappliedSlash
   **/
  ...
  /**
   * Lookup774: pallet_ah_migrator::MigrationStage
   **/
  PalletAhMigratorMigrationStage: {
    _enum: ['Pending', 'DataMigrationOngoing', 'MigrationDone']
  },
  /**
   * Lookup777: pallet_rc_migrator::types::MigrationFinishedData<Balance>
   **/
  PalletRcMigratorMigrationFinishedData: {
    rcBalanceKept: 'u128'
  },
  /**
   * Lookup786: pallet_ah_ops::pallet::Event<T>
   **/
  PalletAhOpsEvent: {
    _enum: {
  ...
  /**
   * Lookup787: pallet_ah_migrator::pallet::Event<T>
   **/
  ...
  /**
   * Lookup788: pallet_ah_migrator::PalletEventName
   **/
  ...
  /**
   * Lookup828: cumulus_pallet_parachain_system::parachain_inherent::InboundMessageId
   **/
  ...
  /**
   * Lookup856: pallet_election_provider_multi_block::signed::pallet::HoldReason
   **/
  PalletElectionProviderMultiBlockSignedPalletHoldReason: {
    _enum: ['SignedSubmission']
  },
  /**
   * Lookup857: pallet_staking_async::pallet::pallet::HoldReason
   **/
  ...
  /**
   * Lookup1054: pallet_election_provider_multi_block::pallet::Error<T>
   **/
  PalletElectionProviderMultiBlockError: {
    _enum: ['Fallback', 'UnexpectedPhase', 'Snapshot']
  },
  /**
   * Lookup1055: pallet_election_provider_multi_block::verifier::impls::ValidSolution
   **/
  PalletElectionProviderMultiBlockVerifierImplsValidSolution: {
    _enum: ['X', 'Y']
  },
  /**
   * Lookup1058: pallet_election_provider_multi_block::verifier::impls::PartialBackings
   **/
  ...
  /**
   * Lookup1060: pallet_election_provider_multi_block::verifier::impls::Status
   **/
  ...
  /**
   * Lookup1066: pallet_election_provider_multi_block::signed::SubmissionMetadata<T>
   **/
  ...
  /**
   * Lookup1069: pallet_election_provider_multi_block::signed::pallet::Error<T>
   **/
  ...
  /**
   * Lookup1070: pallet_staking_async::ledger::StakingLedger<T>
   **/
  ...
  /**
   * Lookup1071: pallet_staking_async::Nominations<T>
   **/
  ...
  /**
   * Lookup1072: pallet_staking_async::ActiveEraInfo
   **/
  ...
  /**
   * Lookup1075: pallet_staking_async::pallet::pallet::BoundedExposurePage<T>
   **/
  PalletStakingAsyncPalletBoundedExposurePage: 'SpStakingExposurePage',
  /**
   * Lookup1080: pallet_staking_async::EraRewardPoints<T>
   **/
  ...
  /**
   * Lookup1083: pallet_staking_async::slashing::OffenceRecord<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup1087: pallet_staking_async::UnappliedSlash<T>
   **/
  ...
  /**
   * Lookup1090: pallet_staking_async::SnapshotStatus<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup1092: pallet_staking_async::pallet::pallet::PruningStep
   **/
  ...
  /**
   * Lookup1093: pallet_staking_async::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup1104: pallet_referenda::types::ReferendumInfo<TrackId, asset_hub_kusama_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<asset_hub_kusama_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup1105: pallet_referenda::types::ReferendumStatus<TrackId, asset_hub_kusama_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<asset_hub_kusama_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup1123: pallet_ah_ops::pallet::Error<T>
   **/
  PalletAhOpsError: {
  ...
  /**
   * Lookup1124: pallet_ah_migrator::BalancesBefore<Balance>
   **/
  ...
  /**
   * Lookup1125: pallet_ah_migrator::pallet::Error<T>
   **/
