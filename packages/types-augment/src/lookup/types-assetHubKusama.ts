...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletElectionProviderMultiBlockCall (452) */
  ...
  /** @name PalletElectionProviderMultiBlockAdminOperation (453) */
  ...
  /** @name PalletElectionProviderMultiBlockVerifierImplsPalletCall (462) */
  type PalletElectionProviderMultiBlockVerifierImplsPalletCall = Null;

  /** @name PalletElectionProviderMultiBlockUnsignedPalletCall (463) */
  ...
  /** @name PalletElectionProviderMultiBlockPagedRawSolution (464) */
  ...
  /** @name PalletElectionProviderMultiBlockSignedPalletCall (541) */
  ...
  /** @name PalletStakingAsyncPalletCall (543) */
  ...
  /** @name PalletStakingAsyncPalletConfigOpU128 (548) */
  ...
  /** @name PalletStakingAsyncPalletConfigOpU32 (549) */
  ...
  /** @name PalletStakingAsyncPalletConfigOpPercent (550) */
  ...
  /** @name PalletStakingAsyncPalletConfigOpPerbill (551) */
  ...
  /** @name PalletStakingAsyncLedgerUnlockChunk (555) */
  interface PalletStakingAsyncLedgerUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletAhOpsCall (569) */
  ...
  /** @name PalletRcMigratorAccountsAccount (572) */
  ...
  /** @name PalletRcMigratorPortableHoldReason (573) */
  ...
  /** @name PalletRcMigratorPortableFreezeReason (580) */
  ...
  /** @name PalletRcMigratorMultisigRcMultisig (593) */
  interface PalletRcMigratorMultisigRcMultisig extends Struct {
    readonly creator: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletRcMigratorProxyRcProxy (595) */
  ...
  /** @name PalletRcMigratorProxyRcProxyAnnouncement (600) */
  interface PalletRcMigratorProxyRcProxyAnnouncement extends Struct {
    readonly depositor: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletRcMigratorPreimageChunksRcPreimageChunk (602) */
  ...
  /** @name PalletRcMigratorPreimageRequestStatusPortableRequestStatus (605) */
  ...
  /** @name PalletRcMigratorPreimageRequestStatusPortableRequestStatusInner (606) */
  ...
  /** @name PalletRcMigratorPreimageLegacyRequestStatusRcPreimageLegacyStatus (611) */
  ...
  /** @name PalletRcMigratorStakingNomPoolsRcNomPoolsMessage (613) */
  ...
  /** @name PalletRcMigratorStakingNomPoolsNomPoolsStorageValues (614) */
  ...
  /** @name PalletRcMigratorStakingNomPoolsAliasRewardPool (627) */
  ...
  /** @name PalletRcMigratorStakingNomPoolsAliasSubPools (629) */
  ...
  /** @name PalletReferendaReferendumInfoRcPalletsOrigin (649) */
  ...
  /** @name PalletReferendaReferendumStatusRcPalletsOrigin (652) */
  ...
  /** @name PalletRcMigratorClaimsRcClaimsMessage (660) */
  ...
  /** @name PalletRcMigratorStakingBagsListPortableBagsListMessage (665) */
  ...
  /** @name PalletRcMigratorStakingBagsListPortableNode (666) */
  ...
  /** @name PalletRcMigratorStakingBagsListPortableBag (667) */
  ...
  /** @name PalletRcMigratorSchedulerRcSchedulerMessage (669) */
  ...
  /** @name PalletRcMigratorIndicesRcIndicesIndex (674) */
  ...
  /** @name PalletRcMigratorConvictionVotingRcConvictionVotingMessage (676) */
  ...
  /** @name PalletRcMigratorBountiesRcBountiesMessage (688) */
  ...
  /** @name PalletRcMigratorBountiesAliasBounty (691) */
  ...
  /** @name PalletRcMigratorCrowdloanRcCrowdloanMessage (696) */
  ...
  /** @name PalletRcMigratorTreasuryPortableTreasuryMessage (700) */
  ...
  /** @name PalletRcMigratorTreasuryPortableSpendStatus (703) */
  ...
  /** @name PalletRcMigratorTreasuryPortablePaymentState (704) */
  ...
  /** @name PalletRcMigratorSchedulerSchedulerAgendaMessage (706) */
  ...
  /** @name PalletRcMigratorSchedulerAliasScheduled (707) */
  ...
  /** @name PalletRcMigratorStakingDelegatedStakingPortableDelegatedStakingMessage (711) */
  ...
  /** @name PalletRcMigratorChildBountiesPortableChildBountiesMessage (713) */
  ...
  /** @name PalletRcMigratorChildBountiesPortableChildBounty (714) */
  ...
  /** @name PalletRcMigratorChildBountiesPortableChildBountyStatus (715) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableStakingMessage (718) */
  ...
  /** @name PalletRcMigratorStakingMessageStakingValues (719) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableActiveEraInfo (721) */
  interface PalletRcMigratorStakingMessagePortableActiveEraInfo extends Struct {
    readonly index: u32;
    readonly start: Option<u64>;
  }

  /** @name PalletRcMigratorStakingMessagePortableForcing (723) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableStakingLedger (725) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableUnlockChunk (727) */
  interface PalletRcMigratorStakingMessagePortableUnlockChunk extends Struct {
    readonly value: u128;
    readonly era: u32;
  }

  /** @name PalletRcMigratorStakingMessagePortableRewardDestination (729) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableValidatorPrefs (730) */
  interface PalletRcMigratorStakingMessagePortableValidatorPrefs extends Struct {
    readonly commission: Perbill;
    readonly blocked: bool;
  }

  /** @name PalletRcMigratorStakingMessagePortableNominations (731) */
  ...
  /** @name PalletRcMigratorStakingMessagePortablePagedExposureMetadata (733) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableExposurePage (734) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableIndividualExposure (736) */
  interface PalletRcMigratorStakingMessagePortableIndividualExposure extends Struct {
    readonly who: AccountId32;
    readonly value: u128;
  }

  /** @name PalletRcMigratorStakingMessagePortableEraRewardPoints (738) */
  ...
  /** @name PalletRcMigratorStakingMessagePortableUnappliedSlash (740) */
  ...
  /** @name PalletAhMigratorMigrationStage (774) */
  ...
  /** @name PalletAhMigratorEvent (787) */
  ...
  /** @name PalletAhMigratorPalletEventName (788) */
  ...
  /** @name CumulusPalletParachainSystemParachainInherentInboundMessageId (828) */
  ...
  /** @name PalletElectionProviderMultiBlockSignedPalletHoldReason (856) */
  ...
  /** @name PalletStakingAsyncPalletHoldReason (857) */
  ...
  /** @name PalletElectionProviderMultiBlockError (1054) */
  ...
  /** @name PalletElectionProviderMultiBlockVerifierImplsValidSolution (1055) */
  ...
  /** @name PalletElectionProviderMultiBlockVerifierImplsPartialBackings (1058) */
  interface PalletElectionProviderMultiBlockVerifierImplsPartialBackings extends Struct {
    readonly total: u128;
    readonly backers: u32;
  }

  /** @name PalletElectionProviderMultiBlockVerifierImplsStatus (1060) */
  ...
  /** @name PalletElectionProviderMultiBlockSignedSubmissionMetadata (1066) */
  ...
  /** @name PalletElectionProviderMultiBlockSignedPalletError (1069) */
  ...
  /** @name PalletStakingAsyncLedgerStakingLedger (1070) */
  ...
  /** @name PalletStakingAsyncNominations (1071) */
  ...
  /** @name PalletStakingAsyncUnappliedSlash (1087) */
  ...
  /** @name PalletStakingAsyncSnapshotStatus (1090) */
  ...
  /** @name PalletStakingAsyncPalletPruningStep (1092) */
  ...
  /** @name PalletStakingAsyncPalletError (1093) */
  ...
  /** @name PalletReferendaReferendumInfoOriginCaller (1104) */
  ...
  /** @name PalletReferendaReferendumStatusOriginCaller (1105) */
  ...
  /** @name PalletAhMigratorBalancesBefore (1124) */
  interface PalletAhMigratorBalancesBefore extends Struct {
    readonly checkingAccount: u128;
    readonly totalIssuance: u128;
  }

  /** @name PalletAhMigratorError (1125) */
  ...
  /** @name XcmRuntimeApisTrustedQueryError (1189) */
  ...
  /** @name XcmRuntimeApisAuthorizedAliasesError (1191) */
