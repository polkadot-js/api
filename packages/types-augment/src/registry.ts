...
import type { AliveContractInfo, CodeHash, CodeSource, ContractCallFlags, ContractCallRequest, ContractCallRequestTo267, ContractExecResult, ContractExecResultErr, ContractExecResultErrModule, ContractExecResultOk, ContractExecResultResult, ContractExecResultSuccessTo255, ContractExecResultSuccessTo260, ContractExecResultTo255, ContractExecResultTo260, ContractExecResultTo267, ContractInfo, ContractInstantiateRequest, ContractInstantiateResult, ContractInstantiateResultOk, ContractInstantiateResultOkTo267, ContractInstantiateResultResult, ContractReturnFlags, ContractStorageKey, DeletedContract, ExecReturnValue, Gas, HostFnWeights, HostFnWeightsTo264, InstructionWeights, Limits, LimitsTo264, PrefabWasmModule, RentProjection, Schedule, ScheduleTo212, ScheduleTo258, ScheduleTo264, SeedOf, StorageDeposit, TombstoneContractInfo, TrieId } from '@polkadot/types/interfaces/contracts';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    ContractCallRequestTo267: ContractCallRequestTo267;
    ...
    ContractInstantiateRequest: ContractInstantiateRequest;
    ContractInstantiateResult: ContractInstantiateResult;
    ContractInstantiateResultOk: ContractInstantiateResultOk;
    ContractInstantiateResultOkTo267: ContractInstantiateResultOkTo267;
    ContractInstantiateResultResult: ContractInstantiateResultResult;
