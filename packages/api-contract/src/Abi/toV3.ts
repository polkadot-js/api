...
import type { ContractConstructorSpecV2, ContractEventSpecV2, ContractMessageSpecV2, ContractMetadataV2, ContractMetadataV3 } from '@polkadot/types/interfaces';
...
export function v2ToV3 (registry: Registry, v2: ContractMetadataV2): ContractMetadataV3 {
  return registry.createType('ContractMetadataV3', objectSpread({}, v2, {
    spec: objectSpread({}, v2.spec, {
      constructors: v2ToV3Labels(registry, 'ContractConstructorSpec', v2.spec.constructors),
