...
import type { FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime, PalletAllianceCid, PalletAllianceDisbandWitness, PalletAllianceUnscrupulousItem, PalletCoreFellowshipParamsType, PalletCoreFellowshipWish, PalletMultisigTimepoint, SpWeightsWeightV2Weight, XcmV3WeightLimit, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: CollectivesPolkadotRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Alliance' | 'Fellowship' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectivesPolkadotRuntimeProxyType, u32, u16]>;
      /**
       * See [`Pallet::kill_pure`].
       **/
      killPure: AugmentedSubmittable<(spawner: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, proxyType: CollectivesPolkadotRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Alliance' | 'Fellowship' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, CollectivesPolkadotRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       * See [`Pallet::proxy`].
       **/
      proxy: AugmentedSubmittable<(real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<CollectivesPolkadotRuntimeProxyType> | null | Uint8Array | CollectivesPolkadotRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Alliance' | 'Fellowship' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, Option<CollectivesPolkadotRuntimeProxyType>, Call]>;
      /**
       * See [`Pallet::proxy_announced`].
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<CollectivesPolkadotRuntimeProxyType> | null | Uint8Array | CollectivesPolkadotRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Alliance' | 'Fellowship' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, MultiAddress, Option<CollectivesPolkadotRuntimeProxyType>, Call]>;
      /**
    ...
    session: {
       ...
       * See [`Pallet::set_keys`].
       **/
      setKeys: AugmentedSubmittable<(keys: CollectivesPolkadotRuntimeSessionKeys | { aura?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectivesPolkadotRuntimeSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: CollectivesPolkadotRuntimeOriginCaller | { system: any } | { Void: any } | { PolkadotXcm: any } | { CumulusXcm: any } | { AllianceMotion: any } | { FellowshipOrigins: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectivesPolkadotRuntimeOriginCaller, Call]>;
      /**
