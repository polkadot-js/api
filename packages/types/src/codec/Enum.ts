...
function isRustEnum (def: Record<string, keyof InterfaceTypes | WrappedConstructor | Constructor> | Record<string, number>): def is Record<string, keyof InterfaceTypes | Constructor> {
...
function extractDef (registry: Registry, _def: Record<string, keyof InterfaceTypes | WrappedConstructor | Constructor> | Record<string, number> | string[]): { def: TypesDef; isBasic: boolean; isIndexed: boolean } {
...
export class Enum implements Codec {
  ...
  constructor (registry: Registry, def: Record<string, keyof InterfaceTypes | WrappedConstructor | Constructor> | Record<string, number> | string[], value?: unknown, index?: number) {
  ...
  public static with (Types: Record<string, keyof InterfaceTypes | Constructor | WrappedConstructor> | Record<string, number> | string[]): EnumConstructor<Enum> {
