...
import { Bytes, Data, Fixed64, GenericAccountId, GenericAccountIndex, GenericAddress, GenericBlock, GenericConsensusEngineId, GenericDigest, GenericDigestItem, GenericEvent, GenericExtrinsic, GenericExtrinsicEra, GenericExtrinsicPayload, GenericImmortalEra, GenericMortalEra, GenericVote, H160, H256, H512, I128, I16, I256, I32, I64, I8, Method, Moment, Null, Origin, StorageHasher, StorageKey, Text, Type, U128, U16, U256, U32, U64, U8, bool, i128, i16, i256, i32, i64, i8, u128, u16, u256, u32, u64, u8, usize } from './primitive';
import { AccountId, AccountIdOf, AccountIndex, Address, Balance, BalanceOf, Block, BlockNumber, Consensus, ConsensusEngineId, Digest, DigestItem, Ed25519Signature, Extrinsic, ExtrinsicEra, ExtrinsicPayload, Hash, Header, ImmortalEra, Index, Justification, KeyTypeId, KeyValue, LockIdentifier, MortalEra, Perbill, Permill, Phantom, PreRuntime, Seal, SealV0, SessionKeys, Signature, SignedBlock, Sr25519Signature, StorageData, ValidatorId, Weight, WeightMultiplier } from './interfaces/runtime';
...
export interface InterfaceRegistry {
  ...
  'Option<GenericExtrinsic>': Option<GenericExtrinsic>;
  'Vec<GenericExtrinsic>': Vec<GenericExtrinsic>;
  GenericExtrinsicEra: GenericExtrinsicEra;
  'Option<GenericExtrinsicEra>': Option<GenericExtrinsicEra>;
  'Vec<GenericExtrinsicEra>': Vec<GenericExtrinsicEra>;
  GenericMortalEra: GenericMortalEra;
  'Option<GenericMortalEra>': Option<GenericMortalEra>;
  'Vec<GenericMortalEra>': Vec<GenericMortalEra>;
  GenericImmortalEra: GenericImmortalEra;
  'Option<GenericImmortalEra>': Option<GenericImmortalEra>;
  'Vec<GenericImmortalEra>': Vec<GenericImmortalEra>;
  GenericExtrinsicPayload: GenericExtrinsicPayload;
  'Option<GenericExtrinsicPayload>': Option<GenericExtrinsicPayload>;
  'Vec<GenericExtrinsicPayload>': Vec<GenericExtrinsicPayload>;
