...
export interface InterfaceRegistry {
  ...
  MtClikeEnumVariant: MtClikeEnumVariant;
  'Option<MtClikeEnumVariant>': Option<MtClikeEnumVariant>;
  'Vec<MtClikeEnumVariant>': Vec<MtClikeEnumVariant>;
  MtEnumVariant: MtEnumVariant;
  'Option<MtEnumVariant>': Option<MtEnumVariant>;
  'Vec<MtEnumVariant>': Vec<MtEnumVariant>;
  MtEnumVariantTupleStruct: MtEnumVariantTupleStruct;
  'Option<MtEnumVariantTupleStruct>': Option<MtEnumVariantTupleStruct>;
  'Vec<MtEnumVariantTupleStruct>': Vec<MtEnumVariantTupleStruct>;
  MtEnumVariantStruct: MtEnumVariantStruct;
  'Option<MtEnumVariantStruct>': Option<MtEnumVariantStruct>;
  'Vec<MtEnumVariantStruct>': Vec<MtEnumVariantStruct>;
  MtEnumVariantUnit: MtEnumVariantUnit;
  'Option<MtEnumVariantUnit>': Option<MtEnumVariantUnit>;
  'Vec<MtEnumVariantUnit>': Vec<MtEnumVariantUnit>;
  MtNamedField: MtNamedField;
  'Option<MtNamedField>': Option<MtNamedField>;
  'Vec<MtNamedField>': Vec<MtNamedField>;
  MtRegistry: MtRegistry;
  'Option<MtRegistry>': Option<MtRegistry>;
  'Vec<MtRegistry>': Vec<MtRegistry>;
  MtRegistryIndex: MtRegistryIndex;
  'Compact<MtRegistryIndex>': Compact<MtRegistryIndex>;
  'Option<MtRegistryIndex>': Option<MtRegistryIndex>;
  'Vec<MtRegistryIndex>': Vec<MtRegistryIndex>;
  MtTypeDef: MtTypeDef;
  'Option<MtTypeDef>': Option<MtTypeDef>;
  'Vec<MtTypeDef>': Vec<MtTypeDef>;
  MtTypeDefClikeEnum: MtTypeDefClikeEnum;
  'Option<MtTypeDefClikeEnum>': Option<MtTypeDefClikeEnum>;
  'Vec<MtTypeDefClikeEnum>': Vec<MtTypeDefClikeEnum>;
  MtTypeDefEnum: MtTypeDefEnum;
  'Option<MtTypeDefEnum>': Option<MtTypeDefEnum>;
  'Vec<MtTypeDefEnum>': Vec<MtTypeDefEnum>;
  MtTypeDefStruct: MtTypeDefStruct;
  'Option<MtTypeDefStruct>': Option<MtTypeDefStruct>;
  'Vec<MtTypeDefStruct>': Vec<MtTypeDefStruct>;
  MtTypeDefTupleStruct: MtTypeDefTupleStruct;
  'Option<MtTypeDefTupleStruct>': Option<MtTypeDefTupleStruct>;
  'Vec<MtTypeDefTupleStruct>': Vec<MtTypeDefTupleStruct>;
  MtTypeDefUnion: MtTypeDefUnion;
  'Option<MtTypeDefUnion>': Option<MtTypeDefUnion>;
  'Vec<MtTypeDefUnion>': Vec<MtTypeDefUnion>;
  MtTypeId: MtTypeId;
  'Option<MtTypeId>': Option<MtTypeId>;
  'Vec<MtTypeId>': Vec<MtTypeId>;
  MtTypeIdArray: MtTypeIdArray;
  'Option<MtTypeIdArray>': Option<MtTypeIdArray>;
  'Vec<MtTypeIdArray>': Vec<MtTypeIdArray>;
  MtTypeIdCustom: MtTypeIdCustom;
  'Option<MtTypeIdCustom>': Option<MtTypeIdCustom>;
  'Vec<MtTypeIdCustom>': Vec<MtTypeIdCustom>;
  MtTypeIdDef: MtTypeIdDef;
  'Option<MtTypeIdDef>': Option<MtTypeIdDef>;
  'Vec<MtTypeIdDef>': Vec<MtTypeIdDef>;
  MtTypeIdPrimitive: MtTypeIdPrimitive;
  'Option<MtTypeIdPrimitive>': Option<MtTypeIdPrimitive>;
  'Vec<MtTypeIdPrimitive>': Vec<MtTypeIdPrimitive>;
  MtTypeIdSlice: MtTypeIdSlice;
  'Option<MtTypeIdSlice>': Option<MtTypeIdSlice>;
  'Vec<MtTypeIdSlice>': Vec<MtTypeIdSlice>;
  MtTypeIdTuple: MtTypeIdTuple;
  'Option<MtTypeIdTuple>': Option<MtTypeIdTuple>;
  'Vec<MtTypeIdTuple>': Vec<MtTypeIdTuple>;
