...
import { AbiArg, AbiConstructor, AbiContract, AbiDef, AbiEvent, AbiMessage, AbiRegistry, AbiReturn, AbiStorage, AbiTypes } from '@polkadot/types/interfaces/contractsAbi';
...
export interface InterfaceRegistry {
  ...
  AbiArg: AbiArg;
  'Option<AbiArg>': Option<AbiArg>;
  'Vec<AbiArg>': Vec<AbiArg>;
  AbiConstructor: AbiConstructor;
  'Option<AbiConstructor>': Option<AbiConstructor>;
  'Vec<AbiConstructor>': Vec<AbiConstructor>;
  AbiContract: AbiContract;
  'Option<AbiContract>': Option<AbiContract>;
  'Vec<AbiContract>': Vec<AbiContract>;
  AbiDef: AbiDef;
  'Option<AbiDef>': Option<AbiDef>;
  'Vec<AbiDef>': Vec<AbiDef>;
  AbiEvent: AbiEvent;
  'Option<AbiEvent>': Option<AbiEvent>;
  'Vec<AbiEvent>': Vec<AbiEvent>;
  AbiMessage: AbiMessage;
  'Option<AbiMessage>': Option<AbiMessage>;
  'Vec<AbiMessage>': Vec<AbiMessage>;
  AbiRegistry: AbiRegistry;
  'Option<AbiRegistry>': Option<AbiRegistry>;
  'Vec<AbiRegistry>': Vec<AbiRegistry>;
  AbiReturn: AbiReturn;
  'Option<AbiReturn>': Option<AbiReturn>;
  'Vec<AbiReturn>': Vec<AbiReturn>;
  AbiStorage: AbiStorage;
  'Option<AbiStorage>': Option<AbiStorage>;
  'Vec<AbiStorage>': Vec<AbiStorage>;
  AbiTypes: AbiTypes;
  'Option<AbiTypes>': Option<AbiTypes>;
  'Vec<AbiTypes>': Vec<AbiTypes>;
