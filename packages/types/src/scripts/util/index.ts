...
export function tsTupleA ({ name: tupleName, sub }: TypeDef, imports: TypeImports): string {
  setImports(imports, ['Codec', 'Tuple']);
...
export function getDerivedTypes (type: string, primitiveName: string, imports: TypeImports, indent = 2): string {
...
// etc
export function getSimilarTypes (imports: Imports, type: string): string[] {
