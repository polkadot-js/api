...
import type { AnyJson, AnyTuple, AnyU8a, ArgsDef, CodecRegistry } from '@polkadot/types-codec/types';
...
import type { CallBase, ExtrinsicPayloadValue, IExtrinsic, IKeyringPair, IMethod, Registry, SignatureOptions } from '../types';
