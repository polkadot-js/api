...
export class ModuleMetadataV1 extends Struct {
  public constructor (value?: any) {
    super({
      ...
      calls: Option.with(Vec.with('FunctionMetadataV1')),
      events: Option.with(Vec.with('EventMetadataV1'))
    }, value);
  }
...
const _MetadataV1: Constructor<MetadataInterface<ModuleMetadataV1>> = Struct.with({
 ...
 */
export default class MetadataV1 extends _MetadataV1 {}
