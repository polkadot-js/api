...
export class ModuleMetadataV4 extends Struct {
  public constructor (value?: any) {
    super({
      ...
      calls: Option.with(Vec.with('FunctionMetadataV4')),
      events: Option.with(Vec.with('EventMetadataV4'))
    }, value);
  }
...
const _MetadataV4: Constructor<MetadataInterface<ModuleMetadataV4>> = Struct.with({
 ...
 */
export default class MetadataV4 extends _MetadataV4 {}
