...
export class ModuleMetadataV3 extends Struct {
  public constructor (value?: any) {
    super({
      ...
      calls: Option.with(Vec.with('FunctionMetadataV3')),
      events: Option.with(Vec.with('EventMetadataV3'))
    }, value);
  }
...
const _MetadataV3: Constructor<MetadataInterface<ModuleMetadataV3>> = Struct.with({
 ...
 */
export default class MetadataV3 extends _MetadataV3 {}
