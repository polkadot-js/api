...
import extrinsicsFn from '@polkadot/extrinsics/static';
...
describe('Extrinsic', () => {
  beforeAll(() => {
    typeRegistry.injectMethods(extrinsics);
  });

  it.skip('decodes a non-signed properly via JSON', wrapWithTypeRegistry(typeRegistry, () => {
  ...
  it('decodes an actual transaction (new format)', wrapWithTypeRegistry(typeRegistry, () => {
  ...
  it('decodes an actual transaction (old format)', wrapWithTypeRegistry(typeRegistry, () => {
