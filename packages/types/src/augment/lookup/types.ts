...
export interface FrameSystemAccountInfo extends Struct {
  ...
  readonly data: { free: u128; reserved: u128; miscFrozen: u128; feeFrozen: u128; } & Struct;
}
...
export interface SpRuntimeGenericDigestDigestItem extends Enum {
  ...
  readonly asChangesTrieRoot: PrimitiveTypesH256;
...
export interface FrameSystemEventRecord extends Struct {
  readonly phase: { /** TODO generate fields **/ } & Enum;
  readonly event: { /** TODO generate fields **/ } & Enum;
  readonly topics: Vec<PrimitiveTypesH256>;
}

/** @name FrameSupportWeightsDispatchInfo */
export interface FrameSupportWeightsDispatchInfo extends Struct {
  readonly weight: u64;
  readonly class: { /** TODO generate fields **/ } & Enum;
  readonly paysFee: { /** TODO generate fields **/ } & Enum;
}
...
export interface SpRuntimeDispatchError extends Enum {
  ...
  readonly asModule: { index: u8; error: u8; } & Struct;
...
/** @name Lookup39 */
export interface Lookup39 extends Vec<SpCoreCryptoAccountId32> {}
...
/** @name Lookup49 */
export interface Lookup49 extends ITuple<[SpCoreCryptoAccountId32, u128]> {}
...
/** @name Lookup64 */
export interface Lookup64 extends ITuple<[SpCoreCryptoAccountId32, PalletStakingExposure]> {}
...
/** @name Lookup98 */
export interface Lookup98 extends Vec<PrimitiveTypesH256> {}
...
/** @name Lookup104 */
export interface Lookup104 extends u32 {}
...
export interface FrameSystemLimitsBlockWeights extends Struct {
  ...
  readonly perClass: { normal: FrameSystemLimitsWeightsPerClass; operational: FrameSystemLimitsWeightsPerClass; mandatory: FrameSystemLimitsWeightsPerClass; } & Struct;
}

/** @name FrameSupportWeightsPerDispatchClass */
export interface FrameSupportWeightsPerDispatchClass extends Struct {
  readonly normal: { baseExtrinsic: u64; maxExtrinsic: OptionU64; maxTotal: OptionU64; reserved: OptionU64; } & Struct;
  readonly operational: { baseExtrinsic: u64; maxExtrinsic: OptionU64; maxTotal: OptionU64; reserved: OptionU64; } & Struct;
  readonly mandatory: { baseExtrinsic: u64; maxExtrinsic: OptionU64; maxTotal: OptionU64; reserved: OptionU64; } & Struct;
}
...
export interface FrameSystemLimitsBlockLength extends Struct {
  readonly max: { normal: u32; operational: u32; mandatory: u32; } & Struct;
}
...
/** @name Lookup122 */
export interface Lookup122 extends Vec<NodeRuntimeCall> {}
...
export interface SpConsensusSlotsEquivocationProof extends Struct {
  ...
  readonly slot: u64;
  readonly firstHeader: { parentHash: PrimitiveTypesH256; number: CompactU32; stateRoot: PrimitiveTypesH256; extrinsicsRoot: PrimitiveTypesH256; digest: SpRuntimeGenericDigest; } & Struct;
  readonly secondHeader: { parentHash: PrimitiveTypesH256; number: CompactU32; stateRoot: PrimitiveTypesH256; extrinsicsRoot: PrimitiveTypesH256; digest: SpRuntimeGenericDigest; } & Struct;
}
...
export interface SpRuntimeGenericHeader extends Struct {
  ...
  readonly digest: { logs: Vec<SpRuntimeGenericDigestDigestItem>; } & Struct;
}
...
/** @name Lookup128 */
export interface Lookup128 extends u64 {}
...
export interface SpConsensusBabeDigestsNextConfigDescriptor extends Enum {
  ...
  readonly asV1: { c: ITuple<[u64, u64]>; allowedSlots: SpConsensusBabeAllowedSlots; } & Struct;
}
...
export interface PalletElectionProviderMultiPhaseRawSolution extends Struct {
  readonly compact: { votes1: Vec<ITuple<[CompactU32, CompactU16]>>; votes2: Vec<ITuple<[CompactU32, ITuple<[CompactU16, Compact<u16>]>, CompactU16]>>; votes3: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);2], CompactU16]>>; votes4: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);3], CompactU16]>>; votes5: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);4], CompactU16]>>; votes6: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);5], CompactU16]>>; votes7: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);6], CompactU16]>>; votes8: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);7], CompactU16]>>; votes9: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);8], CompactU16]>>; votes10: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);9], CompactU16]>>; votes11: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);10], CompactU16]>>; votes12: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);11], CompactU16]>>; votes13: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);12], CompactU16]>>; votes14: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);13], CompactU16]>>; votes15: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);14], CompactU16]>>; votes16: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);15], CompactU16]>>; } & Struct;
...
export interface NodeRuntimeNposCompactSolution16 extends Struct {
  ...
  readonly votes2: Vec<ITuple<[CompactU32, ITuple<[CompactU16, Compact<u16>]>, CompactU16]>>;
  readonly votes3: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);2], CompactU16]>>;
  readonly votes4: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);3], CompactU16]>>;
  readonly votes5: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);4], CompactU16]>>;
  readonly votes6: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);5], CompactU16]>>;
  readonly votes7: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);6], CompactU16]>>;
  readonly votes8: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);7], CompactU16]>>;
  readonly votes9: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);8], CompactU16]>>;
  readonly votes10: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);9], CompactU16]>>;
  readonly votes11: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);10], CompactU16]>>;
  readonly votes12: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);11], CompactU16]>>;
  readonly votes13: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);12], CompactU16]>>;
  readonly votes14: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);13], CompactU16]>>;
  readonly votes15: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);14], CompactU16]>>;
  readonly votes16: Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);15], CompactU16]>>;
}
...
/** @name Lookup147 */
export interface Lookup147 extends Vec<ITuple<[CompactU32, ITuple<[CompactU16, Compact<u16>]>, CompactU16]>> {}

/** @name Lookup148 */
export interface Lookup148 extends ITuple<[CompactU32, ITuple<[CompactU16, Compact<u16>]>, CompactU16]> {}

/** @name Lookup149 */
export interface Lookup149 extends ITuple<[CompactU16, Compact<u16>]> {}

/** @name Lookup150 */
export interface Lookup150 extends Compact<u16> {}

/** @name Lookup151 */
export interface Lookup151 extends u16 {}

/** @name Lookup152 */
export interface Lookup152 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);2], CompactU16]>> {}

/** @name Lookup153 */
export interface Lookup153 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);2], CompactU16]> {}

/** @name Lookup154 */
export interface Lookup154 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup155 */
export interface Lookup155 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);3], CompactU16]>> {}

/** @name Lookup156 */
export interface Lookup156 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);3], CompactU16]> {}

/** @name Lookup157 */
export interface Lookup157 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup158 */
export interface Lookup158 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);4], CompactU16]>> {}

/** @name Lookup159 */
export interface Lookup159 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);4], CompactU16]> {}

/** @name Lookup160 */
export interface Lookup160 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup161 */
export interface Lookup161 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);5], CompactU16]>> {}

/** @name Lookup162 */
export interface Lookup162 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);5], CompactU16]> {}

/** @name Lookup163 */
export interface Lookup163 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup164 */
export interface Lookup164 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);6], CompactU16]>> {}

/** @name Lookup165 */
export interface Lookup165 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);6], CompactU16]> {}

/** @name Lookup166 */
export interface Lookup166 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup167 */
export interface Lookup167 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);7], CompactU16]>> {}

/** @name Lookup168 */
export interface Lookup168 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);7], CompactU16]> {}

/** @name Lookup169 */
export interface Lookup169 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup170 */
export interface Lookup170 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);8], CompactU16]>> {}

/** @name Lookup171 */
export interface Lookup171 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);8], CompactU16]> {}

/** @name Lookup172 */
export interface Lookup172 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup173 */
export interface Lookup173 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);9], CompactU16]>> {}

/** @name Lookup174 */
export interface Lookup174 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);9], CompactU16]> {}

/** @name Lookup175 */
export interface Lookup175 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup176 */
export interface Lookup176 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);10], CompactU16]>> {}

/** @name Lookup177 */
export interface Lookup177 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);10], CompactU16]> {}

/** @name Lookup178 */
export interface Lookup178 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup179 */
export interface Lookup179 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);11], CompactU16]>> {}

/** @name Lookup180 */
export interface Lookup180 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);11], CompactU16]> {}

/** @name Lookup181 */
export interface Lookup181 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup182 */
export interface Lookup182 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);12], CompactU16]>> {}

/** @name Lookup183 */
export interface Lookup183 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);12], CompactU16]> {}

/** @name Lookup184 */
export interface Lookup184 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup185 */
export interface Lookup185 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);13], CompactU16]>> {}

/** @name Lookup186 */
export interface Lookup186 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);13], CompactU16]> {}

/** @name Lookup187 */
export interface Lookup187 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup188 */
export interface Lookup188 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);14], CompactU16]>> {}

/** @name Lookup189 */
export interface Lookup189 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);14], CompactU16]> {}

/** @name Lookup190 */
export interface Lookup190 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}

/** @name Lookup191 */
export interface Lookup191 extends Vec<ITuple<[CompactU32, [(CompactU16,Compact<u16>);15], CompactU16]>> {}

/** @name Lookup192 */
export interface Lookup192 extends ITuple<[CompactU32, [(CompactU16,Compact<u16>);15], CompactU16]> {}

/** @name Lookup193 */
export interface Lookup193 extends Vec<ITuple<[CompactU16, Compact<u16>]>> {}
...
/** @name Lookup198 */
export interface Lookup198 extends ITuple<[SpCoreCryptoAccountId32, SpNposElectionsSupport]> {}
...
export interface PalletStakingRewardDestination extends Enum {
  ...
  readonly asAccount: SpCoreCryptoAccountId32;
...
/** @name Lookup203 */
export interface Lookup203 extends Compact<u32> {}

/** @name Lookup204 */
export interface Lookup204 extends Vec<SpRuntimeMultiaddressMultiAddress> {}

/** @name Lookup205 */
export interface Lookup205 extends u8 {}

/** @name Lookup206 */
export interface Lookup206 extends Option<u8> {}
...
export interface PalletDemocracyVoteAccountVoteU128 extends Enum {
  ...
  readonly asStandard: { vote: PalletDemocracyVote; balance: u128; } & Struct;
  readonly isSplit: boolean;
  readonly asSplit: { aye: u128; nay: u128; } & Struct;
}
...
/** @name Lookup215 */
export interface Lookup215 extends Option<SpCoreCryptoAccountId32> {}
...
export interface SpFinalityGrandpaEquivocationProof extends Struct {
  readonly setId: u64;
  readonly equivocation: { /** TODO generate fields **/ } & Enum;
}
...
export interface PalletImOnlineHeartbeatU32 extends Struct {
  ...
  readonly networkState: { peerId: Bytes; externalAddresses: Vec<Bytes>; } & Struct;
...
/** @name Lookup246 */
export interface Lookup246 extends ITuple<[PalletIdentityTypesData, PalletIdentityTypesData]> {}
...
/** @name Lookup279 */
export interface Lookup279 extends ITuple<[SpCoreCryptoAccountId32, PalletIdentityTypesData]> {}
...
/** @name Lookup300 */
export interface Lookup300 extends Compact<u64> {}

/** @name Lookup301 */
export interface Lookup301 extends u64 {}
...
/** @name Lookup304 */
export interface Lookup304 extends Option<SpRuntimeMultiaddressMultiAddress> {}
...
export interface SpConsensusBabeBabeEpochConfiguration extends Struct {
  ...
  readonly allowedSlots: { /** TODO generate fields **/ } & Enum;
}
...
/** @name Lookup316 */
export interface Lookup316 extends ITuple<[SpCoreCryptoAccountId32, u128, bool]> {}
...
export interface PalletBalancesBalanceLockU128 extends Struct {
  ...
  readonly reasons: { /** TODO generate fields **/ } & Enum;
}
...
/** @name Lookup327 */
export interface Lookup327 extends u128 {}
...
export interface PalletElectionProviderMultiPhaseReadySolution extends Struct {
  ...
  readonly score: Vec<u128>;
  readonly compute: { /** TODO generate fields **/ } & Enum;
}
...
export interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
  ...
  readonly targets: Vec<SpCoreCryptoAccountId32>;
}
...
/** @name Lookup336 */
export interface Lookup336 extends ITuple<[SpCoreCryptoAccountId32, u64, Vec<AccountId32>]> {}
...
export interface PalletElectionProviderMultiPhaseSignedSignedSubmission extends Struct {
  ...
  readonly solution: { compact: NodeRuntimeNposCompactSolution16; score: Vec<u128>; round: u32; } & Struct;
}
...
export interface PalletStakingEraRewardPoints extends Struct {
  readonly total: u32;
  readonly individual: BTreeMap<SpCoreCryptoAccountId32, u32>;
}

/** @name Lookup349 */
export interface Lookup349 extends BTreeMap<SpCoreCryptoAccountId32, u32> {}

/** @name Lookup350 */
export interface Lookup350 extends Vec<ITuple<[AccountId32, u32]>> {}

/** @name Lookup351 */
export interface Lookup351 extends ITuple<[SpCoreCryptoAccountId32, u32]> {}
...
export interface PalletStakingUnappliedSlash extends Struct {
  ...
  readonly reporters: Vec<SpCoreCryptoAccountId32>;
  readonly payout: u128;
}

/** @name Lookup355 */
export interface Lookup355 extends ITuple<[u32, u128]> {}
...
/** @name Lookup361 */
export interface Lookup361 extends ITuple<[SpCoreCryptoAccountId32, NodeRuntimeSessionKeys]> {}
...
/** @name Lookup366 */
export interface Lookup366 extends ITuple<[u32, PrimitiveTypesH256, SpCoreCryptoAccountId32]> {}
...
export interface PalletDemocracyPreimageStatus extends Enum {
  ...
  readonly asAvailable: { data: Bytes; provider: SpCoreCryptoAccountId32; deposit: u128; since: u32; expiry: OptionU32; } & Struct;
}
...
export interface PalletDemocracyTypesReferendumInfo extends Enum {
  ...
  readonly asFinished: { approved: bool; end: u32; } & Struct;
}
...
export interface PalletDemocracyTypesReferendumStatus extends Struct {
  ...
  readonly threshold: { /** TODO generate fields **/ } & Enum;
  readonly delay: u32;
  readonly tally: { ayes: u128; nays: u128; turnout: u128; } & Struct;
}
...
export interface PalletDemocracyVoteVoting extends Enum {
  ...
  readonly asDirect: { votes: Vec<ITuple<[u32, PalletDemocracyVoteAccountVoteU128]>>; delegations: PalletDemocracyTypesDelegationsU128; prior: PalletDemocracyVotePriorLock; } & Struct;
  readonly isDelegating: boolean;
  readonly asDelegating: { balance: u128; target: SpCoreCryptoAccountId32; conviction: PalletDemocracyConviction; delegations: PalletDemocracyTypesDelegationsU128; prior: PalletDemocracyVotePriorLock; } & Struct;
}
...
/** @name Lookup377 */
export interface Lookup377 extends ITuple<[PrimitiveTypesH256, PalletDemocracyVoteThreshold]> {}
...
/** @name Lookup381 */
export interface Lookup381 extends Vec<PrimitiveTypesH256> {}

/** @name PalletCollectiveVotes */
export interface PalletCollectiveVotes extends Struct {
  readonly index: u32;
  readonly threshold: u32;
  readonly ayes: Vec<SpCoreCryptoAccountId32>;
  readonly nays: Vec<SpCoreCryptoAccountId32>;
  readonly end: u32;
}

/** @name Lookup384 */
export interface Lookup384 extends Vec<PrimitiveTypesH256> {}
...
export interface PalletElectionsPhragmenVoter extends Struct {
  readonly votes: Vec<SpCoreCryptoAccountId32>;
  readonly stake: u128;
  readonly deposit: u128;
}
...
export interface PalletGrandpaStoredStateU32 extends Enum {
  ...
  readonly asPendingPause: { scheduledAt: u32; delay: u32; } & Struct;
  readonly isPaused: boolean;
  readonly isPendingResume: boolean;
  readonly asPendingResume: { scheduledAt: u32; delay: u32; } & Struct;
}
...
/** @name Lookup396 */
export interface Lookup396 extends u32 {}
...
export interface PalletContractsStorageContractInfo extends Enum {
  ...
  readonly asTombstone: PrimitiveTypesH256;
}
...
export interface PalletContractsSchedule extends Struct {
  readonly limits: { eventTopics: u32; stackHeight: u32; globals: u32; parameters: u32; memoryPages: u32; tableSize: u32; brTableSize: u32; subjectLen: u32; callDepth: u32; payloadLen: u32; codeLen: u32; } & Struct;
  readonly instructionWeights: { version: u32; i64Const: u32; i64Load: u32; i64Store: u32; select: u32; r_if: u32; br: u32; brIf: u32; brTable: u32; brTablePerEntry: u32; call: u32; callIndirect: u32; callIndirectPerParam: u32; localGet: u32; localSet: u32; localTee: u32; globalGet: u32; globalSet: u32; memoryCurrent: u32; memoryGrow: u32; i64Clz: u32; i64Ctz: u32; i64Popcnt: u32; i64Eqz: u32; i64Extendsi32: u32; i64Extendui32: u32; i32Wrapi64: u32; i64Eq: u32; i64Ne: u32; i64Lts: u32; i64Ltu: u32; i64Gts: u32; i64Gtu: u32; i64Les: u32; i64Leu: u32; i64Ges: u32; i64Geu: u32; i64Add: u32; i64Sub: u32; i64Mul: u32; i64Divs: u32; i64Divu: u32; i64Rems: u32; i64Remu: u32; i64And: u32; i64Or: u32; i64Xor: u32; i64Shl: u32; i64Shrs: u32; i64Shru: u32; i64Rotl: u32; i64Rotr: u32; } & Struct;
  readonly hostFnWeights: { caller: u64; address: u64; gasLeft: u64; balance: u64; valueTransferred: u64; minimumBalance: u64; tombstoneDeposit: u64; rentAllowance: u64; blockNumber: u64; now: u64; weightToFee: u64; gas: u64; input: u64; inputPerByte: u64; r_return: u64; returnPerByte: u64; terminate: u64; restoreTo: u64; restoreToPerDelta: u64; random: u64; depositEvent: u64; depositEventPerTopic: u64; depositEventPerByte: u64; debugMessage: u64; setRentAllowance: u64; setStorage: u64; setStoragePerByte: u64; clearStorage: u64; getStorage: u64; getStoragePerByte: u64; transfer: u64; call: u64; callTransferSurcharge: u64; callPerInputByte: u64; callPerOutputByte: u64; instantiate: u64; instantiatePerInputByte: u64; instantiatePerOutputByte: u64; instantiatePerSaltByte: u64; hashSha2256: u64; hashSha2256PerByte: u64; hashKeccak256: u64; hashKeccak256PerByte: u64; hashBlake2256: u64; hashBlake2256PerByte: u64; hashBlake2128: u64; hashBlake2128PerByte: u64; } & Struct;
}
...
export interface SpStakingOffenceOffenceDetails extends Struct {
  readonly offender: ITuple<[SpCoreCryptoAccountId32, PalletStakingExposure]>;
  readonly reporters: Vec<SpCoreCryptoAccountId32>;
}
...
export interface PalletIdentityTypesRegistration extends Struct {
  ...
  readonly deposit: u128;
  readonly info: { additional: Vec<ITuple<[Data, Data]>>; display: PalletIdentityTypesData; legal: PalletIdentityTypesData; web: PalletIdentityTypesData; riot: PalletIdentityTypesData; email: PalletIdentityTypesData; pgpFingerprint: Option<U8aFixed>; image: PalletIdentityTypesData; twitter: PalletIdentityTypesData; } & Struct;
}
...
/** @name Lookup421 */
export interface Lookup421 extends Vec<SpCoreCryptoAccountId32> {}
...
export interface PalletIdentityTypesRegistrarInfo extends Struct {
  ...
  readonly fee: u128;
  readonly fields: { /** TODO generate fields **/ } & Enum;
}
...
export interface PalletSocietyBid extends Struct {
  readonly who: AccountId32;
  readonly kind: { /** TODO generate fields **/ } & Enum;
  readonly value: u128;
}
...
export interface PalletRecoveryRecoveryConfig extends Struct {
  ...
  readonly deposit: u128;
  readonly friends: Vec<SpCoreCryptoAccountId32>;
...
export interface PalletSchedulerScheduledV2 extends Struct {
  ...
  readonly origin: { /** TODO generate fields **/ } & Enum;
}
...
export interface FrameSystemRawOrigin extends Enum {
  ...
  readonly isSigned: boolean;
  readonly asSigned: SpCoreCryptoAccountId32;
  readonly isNone: boolean;
}
...
export interface PalletCollectiveRawOriginInstance1 extends Enum {
  ...
  readonly isMember: boolean;
  readonly asMember: SpCoreCryptoAccountId32;
...
export interface PalletProxyProxyDefinition extends Struct {
  ...
  readonly proxyType: { /** TODO generate fields **/ } & Enum;
  readonly delay: u32;
}
...
export interface PalletMultisigMultisig extends Struct {
  readonly when: { height: u32; index: u32; } & Struct;
  readonly deposit: u128;
  readonly depositor: AccountId32;
  readonly approvals: Vec<SpCoreCryptoAccountId32>;
}

/** @name Lookup460 */
export interface Lookup460 extends ITuple<[Bytes, SpCoreCryptoAccountId32, u128]> {}
...
export interface PalletBountiesBounty extends Struct {
  ...
  readonly bond: u128;
  readonly status: { /** TODO generate fields **/ } & Enum;
}
...
export interface PalletBountiesBountyStatus extends Enum {
  ...
  readonly asCuratorProposed: { curator: SpCoreCryptoAccountId32; } & Struct;
  readonly isActive: boolean;
  readonly asActive: { curator: SpCoreCryptoAccountId32; updateDue: u32; } & Struct;
  readonly isPendingPayout: boolean;
  readonly asPendingPayout: { curator: SpCoreCryptoAccountId32; beneficiary: SpCoreCryptoAccountId32; unlockAt: u32; } & Struct;
}
...
/** @name Lookup469 */
export interface Lookup469 extends ITuple<[u32, SpCoreCryptoAccountId32, SpCoreCryptoAccountId32]> {}
...
/** @name Lookup483 */
export interface Lookup483 extends ITuple<[SpCoreCryptoAccountId32, u32, u32]> {}

/** @name PalletUniquesTypesInstanceDetails */
export interface PalletUniquesTypesInstanceDetails extends Struct {
  readonly owner: AccountId32;
  readonly approved: Option<SpCoreCryptoAccountId32>;
  readonly isFrozen: bool;
  readonly deposit: u128;
}
