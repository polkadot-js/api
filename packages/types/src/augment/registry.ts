...
import type { EthAccountId, EthBlock, EthBlockTransactions, EthCallRequest, EthFilter, EthFilterAddress, EthFilterTopic, EthFilterTopicEntry, EthFilterTopicInner, EthHeader, EthLog, EthLookupSource, EthReceipt, EthRichBlock, EthRichHeader, EthSubKind, EthSubParams, EthSubResult, EthSyncInfo, EthSyncStatus, EthTransaction, EthTransactionCondition, EthWork, EthereumAccountId, EthereumLookupSource } from '@polkadot/types/interfaces/eth';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    EthAccountId: EthAccountId;
    'Option<EthAccountId>': Option<EthAccountId>;
    'Vec<EthAccountId>': Vec<EthAccountId>;
    EthLookupSource: EthLookupSource;
    'Option<EthLookupSource>': Option<EthLookupSource>;
    'Vec<EthLookupSource>': Vec<EthLookupSource>;
    EthBlock: EthBlock;
    'Option<EthBlock>': Option<EthBlock>;
    'Vec<EthBlock>': Vec<EthBlock>;
    EthBlockTransactions: EthBlockTransactions;
    'Option<EthBlockTransactions>': Option<EthBlockTransactions>;
    'Vec<EthBlockTransactions>': Vec<EthBlockTransactions>;
