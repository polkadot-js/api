...
import { InkConstructorSpec, InkContractSpec, InkEventParamSpec, InkEventSpec, InkLayoutField, InkLayoutKey, InkLayoutRange, InkLayoutStruct, InkMessageParamSpec, InkMessageSpec, InkProject, InkSelector, InkStorageLayout, InkTypeSpec, MtField, MtLookupTextId, MtLookupTypeId, MtRegistry, MtType, MtTypeArray, MtTypeComposite, MtTypePrimitive, MtTypeSlice, MtTypeTuple, MtTypeVariant, MtVariant } from '@polkadot/types/interfaces/contractsAbi';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    MtTypeComposite: MtTypeComposite;
    'Option<MtTypeComposite>': Option<MtTypeComposite>;
    'Vec<MtTypeComposite>': Vec<MtTypeComposite>;
    MtTypeVariant: MtTypeVariant;
    'Option<MtTypeVariant>': Option<MtTypeVariant>;
    'Vec<MtTypeVariant>': Vec<MtTypeVariant>;
    MtTypeArray: MtTypeArray;
    'Option<MtTypeArray>': Option<MtTypeArray>;
    'Vec<MtTypeArray>': Vec<MtTypeArray>;
    MtTypePrimitive: MtTypePrimitive;
    'Option<MtTypePrimitive>': Option<MtTypePrimitive>;
    'Vec<MtTypePrimitive>': Vec<MtTypePrimitive>;
    MtTypeSlice: MtTypeSlice;
    'Option<MtTypeSlice>': Option<MtTypeSlice>;
    'Vec<MtTypeSlice>': Vec<MtTypeSlice>;
    MtTypeTuple: MtTypeTuple;
    'Option<MtTypeTuple>': Option<MtTypeTuple>;
    'Vec<MtTypeTuple>': Vec<MtTypeTuple>;
    MtVariant: MtVariant;
