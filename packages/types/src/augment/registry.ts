...
import { InkConstructorSpec, InkContractSpec, InkEventParamSpec, InkEventSpec, InkLayoutCell, InkLayoutField, InkLayoutKey, InkLayoutRange, InkLayoutStruct, InkMessageParamSpec, InkMessageSpec, InkProject, InkProjectContract, InkProjectSource, InkSelector, InkStorageLayout, InkTypeSpec, MtField, MtLookupTypeId, MtPath, MtRegistry, MtType, MtTypeDef, MtTypeDefArray, MtTypeDefComposite, MtTypeDefPrimitive, MtTypeDefSequence, MtTypeDefTuple, MtTypeDefVariant, MtVariant } from '@polkadot/types/interfaces/contractsAbi';
