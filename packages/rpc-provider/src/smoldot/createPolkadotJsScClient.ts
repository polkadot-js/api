...
import { WellKnownChain, createScClient, Chain, JsonRpcCallback } from "@substrate/connect"
...
/**
 * Returns a {SmoldotClient} that connects to chains, either through the substrate-connect
 ...
 */
export const createSmoldotClient = (): SmoldotClient => {
