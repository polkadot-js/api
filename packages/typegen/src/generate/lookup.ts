...
import staticAhKusama from '@polkadot/types-support/metadata/v16/asset-hub-kusama-hex';
import staticAhPolkadot from '@polkadot/types-support/metadata/v16/asset-hub-polkadot-hex';
import staticKusama from '@polkadot/types-support/metadata/v16/kusama-hex';
import staticPolkadot from '@polkadot/types-support/metadata/v16/polkadot-hex';
import staticSubstrate from '@polkadot/types-support/metadata/v16/substrate-hex';
