...
- **Breaking Change** Vote interface extends U8a instead of I8 and no longer supports the `toNumber()` method. Vote properties can be accessed via the `isAye`, `isNay`, and `conviction` getters. 
