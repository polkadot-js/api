...
*Defined in [packages/api-derive/src/accounts/idAndIndex.ts:53](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api-derive/src/accounts/idAndIndex.ts#L53)*
