...
*Defined in [packages/api-derive/src/accounts/idAndIndex.ts:53](https://github.com/polkadot-js/api/blob/cb93cb34b/packages/api-derive/src/accounts/idAndIndex.ts#L53)*
