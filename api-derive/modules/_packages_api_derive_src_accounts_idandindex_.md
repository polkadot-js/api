...
*Defined in [packages/api-derive/src/accounts/idAndIndex.ts:53](https://github.com/polkadot-js/api/blob/7af915185/packages/api-derive/src/accounts/idAndIndex.ts#L53)*
