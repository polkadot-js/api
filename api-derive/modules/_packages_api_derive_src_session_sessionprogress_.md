...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/27c58b930/packages/api-derive/src/session/sessionProgress.ts#L12)*
