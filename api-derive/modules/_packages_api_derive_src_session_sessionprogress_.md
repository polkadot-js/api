...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/7fd45f63d/packages/api-derive/src/session/sessionProgress.ts#L12)*
