...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/8631f68ba/packages/api-derive/src/session/sessionProgress.ts#L12)*
