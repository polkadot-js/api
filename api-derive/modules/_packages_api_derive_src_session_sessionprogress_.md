...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/cc926596e/packages/api-derive/src/session/sessionProgress.ts#L12)*
