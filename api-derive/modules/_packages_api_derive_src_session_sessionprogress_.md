...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/d20228788/packages/api-derive/src/session/sessionProgress.ts#L12)*
