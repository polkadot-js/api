...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/0c4cc51f7/packages/api-derive/src/session/sessionProgress.ts#L12)*
