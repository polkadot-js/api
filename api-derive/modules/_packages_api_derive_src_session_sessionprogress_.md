...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/33c161f87/packages/api-derive/src/session/sessionProgress.ts#L12)*
