...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/5577723b7/packages/api-derive/src/session/sessionProgress.ts#L12)*
