...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/19d6165bd/packages/api-derive/src/session/sessionProgress.ts#L12)*
