...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/ee6b6da02/packages/api-derive/src/session/sessionProgress.ts#L12)*
