...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:12](https://github.com/polkadot-js/api/blob/cb93cb34b/packages/api-derive/src/session/sessionProgress.ts#L12)*
