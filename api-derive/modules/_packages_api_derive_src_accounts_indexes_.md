...
*Defined in [packages/api-derive/src/accounts/indexes.ts:74](https://github.com/polkadot-js/api/blob/172143f2e/packages/api-derive/src/accounts/indexes.ts#L74)*
