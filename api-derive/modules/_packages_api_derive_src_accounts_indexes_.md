...
*Defined in [packages/api-derive/src/accounts/indexes.ts:74](https://github.com/polkadot-js/api/blob/7fd45f63d/packages/api-derive/src/accounts/indexes.ts#L74)*
