...
*Defined in [packages/api-derive/src/accounts/indexes.ts:74](https://github.com/polkadot-js/api/blob/820dd3d0f/packages/api-derive/src/accounts/indexes.ts#L74)*
