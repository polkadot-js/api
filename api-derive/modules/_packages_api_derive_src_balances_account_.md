...
*Defined in [packages/api-derive/src/balances/account.ts:82](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api-derive/src/balances/account.ts#L82)*
