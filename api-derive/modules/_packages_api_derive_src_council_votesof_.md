...
*Defined in [packages/api-derive/src/council/votesOf.ts:12](https://github.com/polkadot-js/api/blob/b56c1a828/packages/api-derive/src/council/votesOf.ts#L12)*
