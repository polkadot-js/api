...
*Defined in [packages/api-derive/src/council/votesOf.ts:12](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api-derive/src/council/votesOf.ts#L12)*
