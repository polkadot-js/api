...
*Defined in [packages/api-derive/src/chain/getHeader.ts:26](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api-derive/src/chain/getHeader.ts#L26)*
