...
*Defined in [packages/api-derive/src/chain/getHeader.ts:26](https://github.com/polkadot-js/api/blob/6faea13a2/packages/api-derive/src/chain/getHeader.ts#L26)*
