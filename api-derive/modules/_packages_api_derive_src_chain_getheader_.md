...
*Defined in [packages/api-derive/src/chain/getHeader.ts:26](https://github.com/polkadot-js/api/blob/820dd3d0f/packages/api-derive/src/chain/getHeader.ts#L26)*
