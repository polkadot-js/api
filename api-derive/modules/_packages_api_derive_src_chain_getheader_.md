...
*Defined in [packages/api-derive/src/chain/getHeader.ts:26](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api-derive/src/chain/getHeader.ts#L26)*
