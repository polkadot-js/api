...
*Defined in [packages/api-derive/src/chain/getHeader.ts:26](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api-derive/src/chain/getHeader.ts#L26)*
