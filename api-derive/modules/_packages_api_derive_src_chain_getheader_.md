...
*Defined in [packages/api-derive/src/chain/getHeader.ts:26](https://github.com/polkadot-js/api/blob/014fa123b/packages/api-derive/src/chain/getHeader.ts#L26)*
