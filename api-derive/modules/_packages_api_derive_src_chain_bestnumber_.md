...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/d20228788/packages/api-derive/src/chain/bestNumber.ts#L24)*
