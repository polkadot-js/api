...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/b56c1a828/packages/api-derive/src/chain/bestNumber.ts#L24)*
