...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api-derive/src/chain/bestNumber.ts#L24)*
