...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/d3703c072/packages/api-derive/src/chain/bestNumber.ts#L24)*
