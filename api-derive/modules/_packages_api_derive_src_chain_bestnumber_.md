...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api-derive/src/chain/bestNumber.ts#L24)*
