...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/af074500b/packages/api-derive/src/chain/bestNumber.ts#L24)*
