...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/820dd3d0f/packages/api-derive/src/chain/bestNumber.ts#L24)*
