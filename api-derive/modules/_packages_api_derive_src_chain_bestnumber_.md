...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/0c99064b1/packages/api-derive/src/chain/bestNumber.ts#L24)*
