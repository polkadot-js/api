...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/73ffb034d/packages/api-derive/src/chain/bestNumber.ts#L24)*
