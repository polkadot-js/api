...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:24](https://github.com/polkadot-js/api/blob/b4cae1483/packages/api-derive/src/chain/bestNumber.ts#L24)*
