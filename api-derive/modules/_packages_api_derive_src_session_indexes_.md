...
*Defined in [packages/api-derive/src/session/indexes.ts:86](https://github.com/polkadot-js/api/blob/b4cae1483/packages/api-derive/src/session/indexes.ts#L86)*
