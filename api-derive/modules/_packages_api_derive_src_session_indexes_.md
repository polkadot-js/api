...
*Defined in [packages/api-derive/src/session/indexes.ts:86](https://github.com/polkadot-js/api/blob/c6bc664f8/packages/api-derive/src/session/indexes.ts#L86)*
