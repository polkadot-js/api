...
*Defined in [packages/api-derive/src/session/indexes.ts:86](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api-derive/src/session/indexes.ts#L86)*
