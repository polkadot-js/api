...
*Defined in [packages/api-derive/src/tx/constants.ts:6](https://github.com/polkadot-js/api/blob/eda5edbd4/packages/api-derive/src/tx/constants.ts#L6)*
...
*Defined in [packages/api-derive/src/tx/constants.ts:9](https://github.com/polkadot-js/api/blob/eda5edbd4/packages/api-derive/src/tx/constants.ts#L9)*
...
*Defined in [packages/api-derive/src/tx/constants.ts:11](https://github.com/polkadot-js/api/blob/eda5edbd4/packages/api-derive/src/tx/constants.ts#L11)*
...
*Defined in [packages/api-derive/src/tx/constants.ts:13](https://github.com/polkadot-js/api/blob/eda5edbd4/packages/api-derive/src/tx/constants.ts#L13)*
