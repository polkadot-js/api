...
*Defined in [packages/api-derive/src/accounts/accountId.ts:39](https://github.com/polkadot-js/api/blob/172143f2e/packages/api-derive/src/accounts/accountId.ts#L39)*
