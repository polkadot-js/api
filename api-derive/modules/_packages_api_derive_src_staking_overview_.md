...
*Defined in [packages/api-derive/src/staking/overview.ts:15](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api-derive/src/staking/overview.ts#L15)*
