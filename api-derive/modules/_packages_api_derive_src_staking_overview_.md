...
*Defined in [packages/api-derive/src/staking/overview.ts:15](https://github.com/polkadot-js/api/blob/eda5edbd4/packages/api-derive/src/staking/overview.ts#L15)*
