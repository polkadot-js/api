...
*Defined in [packages/api-derive/src/staking/overview.ts:15](https://github.com/polkadot-js/api/blob/b56c1a828/packages/api-derive/src/staking/overview.ts#L15)*
