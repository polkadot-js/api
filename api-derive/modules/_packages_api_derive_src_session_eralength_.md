...
*Defined in [packages/api-derive/src/session/eraLength.ts:12](https://github.com/polkadot-js/api/blob/7fd45f63d/packages/api-derive/src/session/eraLength.ts#L12)*
