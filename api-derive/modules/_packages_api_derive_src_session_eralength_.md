...
*Defined in [packages/api-derive/src/session/eraLength.ts:12](https://github.com/polkadot-js/api/blob/cb93cb34b/packages/api-derive/src/session/eraLength.ts#L12)*
