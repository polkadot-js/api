...
*Defined in [packages/api-derive/src/session/eraLength.ts:12](https://github.com/polkadot-js/api/blob/172143f2e/packages/api-derive/src/session/eraLength.ts#L12)*
