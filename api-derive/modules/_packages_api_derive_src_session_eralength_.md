...
*Defined in [packages/api-derive/src/session/eraLength.ts:12](https://github.com/polkadot-js/api/blob/ee6b6da02/packages/api-derive/src/session/eraLength.ts#L12)*
