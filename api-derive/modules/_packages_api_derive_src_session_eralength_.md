...
*Defined in [packages/api-derive/src/session/eraLength.ts:12](https://github.com/polkadot-js/api/blob/5ce3524cc/packages/api-derive/src/session/eraLength.ts#L12)*
