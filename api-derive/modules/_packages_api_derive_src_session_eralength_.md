...
*Defined in [packages/api-derive/src/session/eraLength.ts:12](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api-derive/src/session/eraLength.ts#L12)*
