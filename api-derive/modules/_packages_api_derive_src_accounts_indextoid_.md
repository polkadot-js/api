...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/172143f2e/packages/api-derive/src/accounts/indexToId.ts#L51)*
