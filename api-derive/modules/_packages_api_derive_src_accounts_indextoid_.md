...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/33c161f87/packages/api-derive/src/accounts/indexToId.ts#L51)*
