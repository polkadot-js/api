...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api-derive/src/accounts/indexToId.ts#L51)*
