...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/d20228788/packages/api-derive/src/accounts/indexToId.ts#L51)*
