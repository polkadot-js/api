...
*Defined in [packages/api-derive/src/collective/proposals.ts:31](https://github.com/polkadot-js/api/blob/7af915185/packages/api-derive/src/collective/proposals.ts#L31)*
