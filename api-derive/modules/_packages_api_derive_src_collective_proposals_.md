...
*Defined in [packages/api-derive/src/collective/proposals.ts:31](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api-derive/src/collective/proposals.ts#L31)*
