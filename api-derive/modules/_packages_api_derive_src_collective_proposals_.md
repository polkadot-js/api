...
*Defined in [packages/api-derive/src/collective/proposals.ts:31](https://github.com/polkadot-js/api/blob/820dd3d0f/packages/api-derive/src/collective/proposals.ts#L31)*
