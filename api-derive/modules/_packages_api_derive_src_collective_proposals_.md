...
*Defined in [packages/api-derive/src/collective/proposals.ts:31](https://github.com/polkadot-js/api/blob/33c161f87/packages/api-derive/src/collective/proposals.ts#L31)*
