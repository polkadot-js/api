...
*Defined in [packages/api-derive/src/session/eraProgress.ts:12](https://github.com/polkadot-js/api/blob/19d6165bd/packages/api-derive/src/session/eraProgress.ts#L12)*
