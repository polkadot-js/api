...
*Defined in [packages/api-derive/src/session/eraProgress.ts:12](https://github.com/polkadot-js/api/blob/7070f757c/packages/api-derive/src/session/eraProgress.ts#L12)*
