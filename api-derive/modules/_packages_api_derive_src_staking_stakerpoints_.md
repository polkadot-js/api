...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:13](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api-derive/src/staking/stakerPoints.ts#L13)*
...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:29](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api-derive/src/staking/stakerPoints.ts#L29)*
