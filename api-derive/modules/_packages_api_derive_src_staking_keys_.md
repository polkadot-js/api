...
*Defined in [packages/api-derive/src/staking/keys.ts:25](https://github.com/polkadot-js/api/blob/014fa123b/packages/api-derive/src/staking/keys.ts#L25)*
...
*Defined in [packages/api-derive/src/staking/keys.ts:33](https://github.com/polkadot-js/api/blob/014fa123b/packages/api-derive/src/staking/keys.ts#L33)*
