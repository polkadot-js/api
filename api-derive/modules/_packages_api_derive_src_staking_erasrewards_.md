...
*Defined in [packages/api-derive/src/staking/erasRewards.ts:23](https://github.com/polkadot-js/api/blob/b4cae1483/packages/api-derive/src/staking/erasRewards.ts#L23)*
...
*Defined in [packages/api-derive/src/staking/erasRewards.ts:55](https://github.com/polkadot-js/api/blob/b4cae1483/packages/api-derive/src/staking/erasRewards.ts#L55)*
