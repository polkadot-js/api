...
*Defined in [packages/api-derive/src/session/progress.ts:74](https://github.com/polkadot-js/api/blob/d3703c072/packages/api-derive/src/session/progress.ts#L74)*
