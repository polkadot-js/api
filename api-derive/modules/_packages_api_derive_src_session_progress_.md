...
*Defined in [packages/api-derive/src/session/progress.ts:74](https://github.com/polkadot-js/api/blob/27c58b930/packages/api-derive/src/session/progress.ts#L74)*
