...
*Defined in [packages/api-derive/src/session/progress.ts:74](https://github.com/polkadot-js/api/blob/7fd45f63d/packages/api-derive/src/session/progress.ts#L74)*
