...
*Defined in [packages/api-derive/src/parachains/info.ts:79](https://github.com/polkadot-js/api/blob/73ffb034d/packages/api-derive/src/parachains/info.ts#L79)*
