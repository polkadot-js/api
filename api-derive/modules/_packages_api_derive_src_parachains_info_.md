...
*Defined in [packages/api-derive/src/parachains/info.ts:79](https://github.com/polkadot-js/api/blob/b56c1a828/packages/api-derive/src/parachains/info.ts#L79)*
