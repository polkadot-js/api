...
*Defined in [packages/api-derive/src/parachains/info.ts:79](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api-derive/src/parachains/info.ts#L79)*
