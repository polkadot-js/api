...
*Defined in [packages/api/src/types/storage.ts:21](https://github.com/polkadot-js/api/blob/172143f2e/packages/api/src/types/storage.ts#L21)*
...
*Defined in [packages/api/src/types/storage.ts:22](https://github.com/polkadot-js/api/blob/172143f2e/packages/api/src/types/storage.ts#L22)*
...
*Defined in [packages/api/src/types/storage.ts:23](https://github.com/polkadot-js/api/blob/172143f2e/packages/api/src/types/storage.ts#L23)*
...
*Defined in [packages/api/src/types/storage.ts:24](https://github.com/polkadot-js/api/blob/172143f2e/packages/api/src/types/storage.ts#L24)*
...
*Defined in [packages/api/src/types/storage.ts:25](https://github.com/polkadot-js/api/blob/172143f2e/packages/api/src/types/storage.ts#L25)*
