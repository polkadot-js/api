...
*Defined in [packages/api/src/types/rpc.ts:17](https://github.com/polkadot-js/api/blob/375dadbe3/packages/api/src/types/rpc.ts#L17)*
...
*Defined in [packages/api/src/types/rpc.ts:18](https://github.com/polkadot-js/api/blob/375dadbe3/packages/api/src/types/rpc.ts#L18)*
