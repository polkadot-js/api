...
*Defined in [packages/api/src/types/base.ts:72](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api/src/types/base.ts#L72)*
...
*Defined in [packages/api/src/types/base.ts:73](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api/src/types/base.ts#L73)*
