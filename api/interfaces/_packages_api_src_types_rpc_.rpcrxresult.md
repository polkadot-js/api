...
*Defined in [packages/api/src/types/base.ts:51](https://github.com/polkadot-js/api/blob/73ffb034d/packages/api/src/types/base.ts#L51)*
...
*Defined in [packages/api/src/types/base.ts:52](https://github.com/polkadot-js/api/blob/73ffb034d/packages/api/src/types/base.ts#L52)*
...
*Defined in [packages/api/src/types/rpc.ts:13](https://github.com/polkadot-js/api/blob/73ffb034d/packages/api/src/types/rpc.ts#L13)*
