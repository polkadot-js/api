...
*Defined in [packages/api/src/types/storage.ts:66](https://github.com/polkadot-js/api/blob/0c99064b1/packages/api/src/types/storage.ts#L66)*
...
*Defined in [packages/api/src/types/storage.ts:67](https://github.com/polkadot-js/api/blob/0c99064b1/packages/api/src/types/storage.ts#L67)*
