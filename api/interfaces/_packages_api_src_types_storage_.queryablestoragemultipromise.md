...
*Defined in [packages/api/src/types/storage.ts:66](https://github.com/polkadot-js/api/blob/172143f2e/packages/api/src/types/storage.ts#L66)*
...
*Defined in [packages/api/src/types/storage.ts:67](https://github.com/polkadot-js/api/blob/172143f2e/packages/api/src/types/storage.ts#L67)*
