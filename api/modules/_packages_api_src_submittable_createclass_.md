...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/9d548f787/packages/api/src/submittable/createClass.ts#L25)*
