...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/acb565d46/packages/api/src/submittable/createClass.ts#L25)*
