...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/014fa123b/packages/api/src/submittable/createClass.ts#L25)*
