...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/af074500b/packages/api/src/submittable/createClass.ts#L25)*
