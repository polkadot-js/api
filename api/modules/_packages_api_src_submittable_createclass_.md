...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api/src/submittable/createClass.ts#L25)*
