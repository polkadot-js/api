...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/ff59962c5/packages/api/src/submittable/createClass.ts#L25)*
