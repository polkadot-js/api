...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/0c99064b1/packages/api/src/submittable/createClass.ts#L25)*
