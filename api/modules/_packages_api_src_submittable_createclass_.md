...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/c6bc664f8/packages/api/src/submittable/createClass.ts#L25)*
