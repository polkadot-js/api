...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/d3703c072/packages/api/src/submittable/createClass.ts#L25)*
