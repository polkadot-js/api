...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/7fd45f63d/packages/api/src/submittable/createClass.ts#L25)*
