...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/820dd3d0f/packages/api/src/submittable/createClass.ts#L25)*
