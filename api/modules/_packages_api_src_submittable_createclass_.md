...
*Defined in [packages/api/src/submittable/createClass.ts:25](https://github.com/polkadot-js/api/blob/27c58b930/packages/api/src/submittable/createClass.ts#L25)*
