...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/014fa123b/packages/api/src/submittable/createSubmittable.ts#L13)*
