...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api/src/submittable/createSubmittable.ts#L13)*
