...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/d20228788/packages/api/src/submittable/createSubmittable.ts#L13)*
