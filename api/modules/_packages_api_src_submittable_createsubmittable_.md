...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/af074500b/packages/api/src/submittable/createSubmittable.ts#L13)*
