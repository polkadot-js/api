...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/7fd45f63d/packages/api/src/submittable/createSubmittable.ts#L13)*
