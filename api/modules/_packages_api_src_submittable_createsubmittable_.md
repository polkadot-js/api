...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/ff59962c5/packages/api/src/submittable/createSubmittable.ts#L13)*
