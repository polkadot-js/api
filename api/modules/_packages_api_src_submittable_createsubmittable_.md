...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/d13e58fb3/packages/api/src/submittable/createSubmittable.ts#L13)*
