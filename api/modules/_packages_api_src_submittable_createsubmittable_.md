...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/820dd3d0f/packages/api/src/submittable/createSubmittable.ts#L13)*
