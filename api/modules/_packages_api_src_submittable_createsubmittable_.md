...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api/src/submittable/createSubmittable.ts#L13)*
