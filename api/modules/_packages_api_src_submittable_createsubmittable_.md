...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/33c161f87/packages/api/src/submittable/createSubmittable.ts#L13)*
