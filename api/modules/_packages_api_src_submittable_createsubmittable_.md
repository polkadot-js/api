...
*Defined in [packages/api/src/submittable/createSubmittable.ts:13](https://github.com/polkadot-js/api/blob/41f1d8f36/packages/api/src/submittable/createSubmittable.ts#L13)*
