...
*Defined in [packages/api/src/util/decorate.ts:12](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api/src/util/decorate.ts#L12)*
...
*Defined in [packages/api/src/util/decorate.ts:43](https://github.com/polkadot-js/api/blob/05c0379f4/packages/api/src/util/decorate.ts#L43)*
