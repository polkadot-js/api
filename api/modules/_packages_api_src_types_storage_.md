...
*Defined in [packages/api/src/types/storage.ts:83](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api/src/types/storage.ts#L83)*
...
*Defined in [packages/api/src/types/storage.ts:85](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api/src/types/storage.ts#L85)*
...
*Defined in [packages/api/src/types/storage.ts:32](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api/src/types/storage.ts#L32)*
...
*Defined in [packages/api/src/types/storage.ts:71](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api/src/types/storage.ts#L71)*
...
*Defined in [packages/api/src/types/storage.ts:58](https://github.com/polkadot-js/api/blob/95c4f03bc/packages/api/src/types/storage.ts#L58)*
