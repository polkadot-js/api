...
*Defined in [packages/api/src/base/Init.ts:30](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api/src/base/Init.ts#L30)*
...
*Defined in [packages/api/src/base/Decorate.ts:173](https://github.com/polkadot-js/api/blob/9f4007bd4/packages/api/src/base/Decorate.ts#L173)*
