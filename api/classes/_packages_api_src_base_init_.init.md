...
*Defined in [packages/api/src/base/Init.ts:30](https://github.com/polkadot-js/api/blob/af074500b/packages/api/src/base/Init.ts#L30)*
...
*Defined in [packages/api/src/base/Decorate.ts:173](https://github.com/polkadot-js/api/blob/af074500b/packages/api/src/base/Decorate.ts#L173)*
