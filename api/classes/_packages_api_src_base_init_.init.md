...
*Defined in [packages/api/src/base/Init.ts:30](https://github.com/polkadot-js/api/blob/d3703c072/packages/api/src/base/Init.ts#L30)*
...
*Defined in [packages/api/src/base/Decorate.ts:170](https://github.com/polkadot-js/api/blob/d3703c072/packages/api/src/base/Decorate.ts#L170)*
