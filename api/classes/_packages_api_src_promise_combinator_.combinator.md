...
*Defined in [packages/api/src/promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [packages/api/src/promise/Combinator.ts:78](https://github.com/polkadot-js/api/blob/3de336fdf/packages/api/src/promise/Combinator.ts#L78)*
